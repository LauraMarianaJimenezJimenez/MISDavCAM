...
export RUTA_DESTINO=${ruta_fuentes_gastos}
...
hdfs dfs -rm -skipTrash $RUTA_DESTINO/TRANSAJU.CSV
hdfs dfs -cp $RUTA_ORIGEN/TRANSAJU_$YEAR$MONTH$DAY.csv $RUTA_DESTINO/TRANSAJU.CSV