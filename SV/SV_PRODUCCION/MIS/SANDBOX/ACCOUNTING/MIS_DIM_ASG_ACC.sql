...
------------ Insercion de Regsitros sin Agrupador Contable ------------
INSERT OVERWRITE MIS_REJECTIONS_DIMENSIONS (DIM_REJ, COD_ENTITY, COD_CURRENCY, COD_GL, COD_GL_GROUP, AMO_EOPBAL, AMO_PL) 
PARTITION (DATA_DATE, COD_CONT)
SELECT 'AGRUPADOR CONTABLE' AS DIM_REJ, DWH.COD_ENTITY, DWH.COD_CURRENCY, DWH.COD_GL, 'N/A', 
...
SELECT DWH.COD_CONT, DWH.COD_GL, DWH.DES_GL, DWH.COD_ACCO_CENT, DWH.COD_BLCE_STATUS, DWH.COD_CURRENCY, 
