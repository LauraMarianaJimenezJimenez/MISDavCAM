...
INSERT INTO MIS_DM_BALANCE_RESULT_AUX 
    ...
    FTP, FTP_RESULT, IND_POOL, EOPBAL_TOT, AVGBAL_TOT, PL_TOT, COD_VALUE, COD_METHOD_FTP, COD_ACT_TYPE)
PARTITION (DATA_DATE)
SELECT 
    ...
    CAST(IFNULL(a.EOPBAL_CAP, 0) + IFNULL(a.EOPBAL_INT, 0) AS decimal(30, 10)) AS EOPBAL_TOT, 
    CAST(IFNULL(a.AVGBAL_CAP, 0) + IFNULL(a.AVGBAL_INT, 0) AS decimal(30, 10)) AS AVGBAL_TOT, 
    CAST(IFNULL(a.PL, 0) + IFNULL(a.FTP_RESULT, 0) AS decimal(30, 10))  AS PL_TOT, a.COD_VALUE, a.COD_METHOD1, a.COD_ACT_TYPE, 
    a.DATA_DATE
...
INSERT INTO MIS_DM_BALANCE_RESULT_AUX 
    ...
    EOPBAL_CAP, EOPBAL_INT, AVGBAL_CAP, AVGBAL_INT, PL, COD_INFO_SOURCE, COD_GL_GROUP, DES_GL_GROUP, ACCOUNT_CONCEPT, 
    COD_PL_ACC, DES_PL_ACC, COD_BLCE_PROD, DES_BLCE_PROD, COD_BUSINESS_LINE, DES_BUSINESS_LINE,
    FTP, FTP_RESULT, IND_POOL, EOPBAL_TOT, AVGBAL_TOT, PL_TOT, COD_VALUE)
PARTITION (DATA_DATE)
SELECT 
    a.CONTENIDO, a.CONTRATO, a.CENTRO_CONTABLE, '1' AS COD_BLCE_STATUS, a.DIVISA, a.ENTIDAD, 'MAN_ADJ' AS COD_PRODUCT, 'OPER' AS COD_SUBPRODUCT, 
    a.IMPORTE_ML, 0 AS EOPBAL_INT, a.SALDO_MEDIO_ML, 0 AS AVGBAL_INT, a.PL_ML, 'ADJ_OPER' AS COD_INFO_SOURCE, a.AGRUPADOR_CONTABLE, NULL AS DES_GL_GROUP, NULL AS ACCOUNT_CONCEPT, 
    a.CUENTA_PG, NULL AS DES_PL_ACC, a.PRODUCTO_BALANCE, NULL AS DES_BLCE_PROD, a.LINEA_DE_NEGOCIO, NULL AS DES_BUSINESS_LINE,
    NULL AS FTP, NULL AS FTP_RESULT, NULL AS IND_POOL,
    CAST(IFNULL(a.IMPORTE_ML, 0) AS decimal(30, 10)) AS EOPBAL_TOT, 
    CAST(IFNULL(a.SALDO_MEDIO_ML, 0) AS decimal(30, 10)) AS AVGBAL_TOT, 
    CAST(IFNULL(a.PL_ML, 0) AS decimal(30, 10))  AS PL_TOT, NULL AS COD_VALUE,
    a.DATA_DATE
...
c.IDF_CLI,c.TYP_DOC_ID,c.NUM_DOC_ID,c.NOM_NAME,c.NOM_LASTN,c.COD_RES_COUNT,c.COD_TYP_CLNT,c.COD_COND_CLNT, 
   ...
   b.DATE_PRX_REV,b.EXP_DATE,b.FREQ_INT_PAY,b.COD_UNI_FREQ_INT_PAY,b.FRE_REV_INT,b.COD_UNI_FRE_REV_INT,b.AMRT_TRM,b.COD_UNI_AMRT_TRM,
    CASE WHEN dup.COD_SUBPRODUCT IS NOT NULL THEN b.INI_AM WHEN m.COD_INFO_SOURCE LIKE '%_M' THEN 0 ELSE b.INI_AM END AS INI_AM,b.CUO_AM,b.CREDIT_LIM_AM,b.PREDEF_RATE_IND,b.PREDEF_RATE,b.IND_CHANNEL, b.COD_OFFI,
    ...
    a.DES_PL_ACC,a.COD_BLCE_PROD,a.DES_BLCE_PROD,a.COD_BUSINESS_LINE,a.DES_BUSINESS_LINE,
    a.FTP,a.FTP_RESULT,a.IND_POOL,a.COD_VALUE, CASE WHEN a.EXP_TYPE IS NOT NULL THEN a.EXP_TYPE        
...
END AS EXP_TYPE, CASE WHEN a.EXP_FAMILY IS NOT NULL THEN a.EXP_FAMILY       
...
END AS EXP_FAMILY, CASE WHEN b.COU_CAR_OFF IS NOT NULL THEN b.COU_CAR_OFF ELSE d.COU_CAR_OFF END AS COU_CAR_OFF, 
CASE WHEN b.COD_CONV IS NOT NULL THEN b.COD_CONV ELSE d.COD_CONV END AS COD_CONV, 
g.DES_CONV, CASE WHEN c.ID_ECO_GRO IS NOT NULL THEN c.ID_ECO_GRO ELSE e.ID_ECO_GRO END AS ID_ECO_GRO, 
...
b.COD_EXEC_CTO, b.COD_COVID_PORT, b.FIELD1_CTO, b.FIELD2_CTO, b.FIELD3_CTO, b.FIELD4_CTO, b.FIELD5_CTO, 
b.FIELD6_CTO, b.FIELD7_CTO, b.FIELD8_CTO, b.FIELD9_CTO, b.FIELD10_CTO, c.FIELD1_CLI, c.FIELD2_CLI, 
c.FIELD3_CLI, c.FIELD4_CLI, c.FIELD5_CLI, c.FIELD6_CLI, c.FIELD7_CLI, c.FIELD8_CLI, c.FIELD9_CLI, 
c.FIELD10_CLI, i.COD_SECTOR_LOCAL, i.DES_SECTOR_LOCAL, i.COD_SECTOR_REG, i.DES_SECTOR_REG, b.DATE_DISB, b.CARD_NUMBER, a.COD_METHOD_FTP, 
j.ID_ECO_GRO_REG, k.DES_ECO_GRO_REG, b.COD_PROG_CARD, n.DES_PROG_CARD, a.COD_ACT_TYPE, a.DATA_DATE
...
ON a.DATA_DATE = b.DATA_DATE AND a.COD_ENTITY = b.COD_ENTITY AND a.IDF_CTO = b.IDF_CTO
...
ON COALESCE(AL4.EXP_FAMILY) IS NULL 
   AND TRIM(AL6.COD_EXPENSE) = '' AND a.COD_ACCO_CENT=AL6.COD_ACCO_CENT AND TRIM(AL6.COD_GL_GROUP) = '' 
...
SELECT a.COD_CONT,a.IDF_CTO,a.COD_VALUE,a.COD_ACCO_CENT,a.COD_OFFI, c.DES_OFFI, a.COD_EXPENSE,a.COD_BLCE_STATUS,a.COD_CURRENCY,a.COD_ENTITY,a.EXP_TYPE,a.EXP_FAMILY,a.COD_PRODUCT,  a.COD_SUBPRODUCT,a.EOPBAL_TOT,a.EOPBAL_CAP,a.EOPBAL_INT,a.AVGBAL_TOT,a.AVGBAL_CAP,a.AVGBAL_INT,a.PL,a.COD_INFO_SOURCE,a.COD_TYP_FEE,
...
a.DATE_PRX_REV,a.EXP_DATE,a.FREQ_INT_PAY,a.COD_UNI_FREQ_INT_PAY,a.FRE_REV_INT,a.COD_UNI_FRE_REV_INT,a.AMRT_TRM,a.COD_UNI_AMRT_TRM,
    a.INI_AM,a.CUO_AM,a.CREDIT_LIM_AM,a.PREDEF_RATE_IND,a.PREDEF_RATE,a.IND_CHANNEL,
    a.PL_TOT,a.AVGBAL_TOT_YTD,a.PL_YTD,a.FTP_RESULT_YTD,a.PL_TOT_YTD,
    CASE 
    ...
    CAST(NULL AS DECIMAL (30,10)) AS AVGBAL_TOT_YTD_RPT,
    CAST(NULL AS DECIMAL (30,10)) AS PL_YTD_RPT,
    CAST(NULL AS DECIMAL (30,6)) AS FTP_RESULT_YTD_RPT,
    CAST(NULL AS DECIMAL (30,10)) AS PL_TOT_YTD_RPT, 
    CASE
    ...
    a.DES_MUL_LAT, a.COD_EXEC_CTO, a.COD_COVID_PORT, A.FIELD1_CTO, A.FIELD2_CTO, A.FIELD3_CTO, A.FIELD4_CTO, A.FIELD5_CTO, A.FIELD6_CTO, A.FIELD7_CTO, A.FIELD8_CTO, A.FIELD9_CTO, A.FIELD10_CTO, A.FIELD1_CLI, A.FIELD2_CLI,
    A.FIELD3_CLI, A.FIELD4_CLI, A.FIELD5_CLI, A.FIELD6_CLI, A.FIELD7_CLI, A.FIELD8_CLI, A.FIELD9_CLI, A.FIELD10_CLI, A.COD_SECTOR_LOCAL, A.DES_SECTOR_LOCAL, A.COD_SECTOR_REG, A.DES_SECTOR_REG, a.DATE_DISB, 
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.PL_TOT, 0)
...
a.CARD_NUMBER, a.COD_METHOD_FTP, a.ID_ECO_GRO_REG, a.DES_ECO_GRO_REG,
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.FTP_RESULT, 0)
...
a.COD_PROG_CARD, a.DES_PROG_CARD, a.COD_ACT_TYPE, a.DATA_DATE
...
COMPUTE INCREMENTAL STATS MIS_TMP_DM_BALANCE_RESULT;

INSERT INTO MIS_DM_BALANCE_RESULT
(COD_CONT,IDF_CTO,COD_ACCO_CENT,COD_OFFI,DES_OFFI,COD_EXPENSE,COD_BLCE_STATUS,COD_CURRENCY,COD_ENTITY,COD_PRODUCT,COD_SUBPRODUCT,
...
DATE_LAST_REV,DATE_PRX_REV,EXP_DATE,FREQ_INT_PAY,COD_UNI_FREQ_INT_PAY,FRE_REV_INT,COD_UNI_FRE_REV_INT,AMRT_TRM,COD_UNI_AMRT_TRM,INI_AM,INI_AM_RPT,INI_AM_USD,INI_AM_REG,CUO_AM,CREDIT_LIM_AM,PREDEF_RATE_IND,PREDEF_RATE,IND_CHANNEL,
...
COD_VALUE, COU_CAR_OFF, COD_CONV, DES_CONV, ID_ECO_GRO, COU_ECO_GRO, DES_ECO_GRO, IND_MUL_LAT, DES_MUL_LAT, COD_EXEC_CTO, COD_COVID_PORT, FIELD1_CTO, FIELD2_CTO, FIELD3_CTO, FIELD4_CTO, FIELD5_CTO, FIELD6_CTO, 
FIELD7_CTO, FIELD8_CTO, FIELD9_CTO, FIELD10_CTO, FIELD1_CLI, FIELD2_CLI, FIELD3_CLI, FIELD4_CLI, FIELD5_CLI, FIELD6_CLI, FIELD7_CLI, FIELD8_CLI, FIELD9_CLI, FIELD10_CLI, 
PL_TOT_USD,PL_TOT_REG,EOPBAL_TOT_USD,EOPBAL_TOT_REG,AVGBAL_TOT_USD,AVGBAL_TOT_REG,COD_SECTOR_LOCAL, DES_SECTOR_LOCAL, COD_SECTOR_REG, DES_SECTOR_REG, DATE_DISB, CARD_NUMBER, COD_METHOD_FTP, ID_ECO_GRO_REG, DES_ECO_GRO_REG, FTP_RESULT_USD, FTP_RESULT_REG, COD_PROG_CARD, DES_PROG_CARD, COD_ACT_TYPE)
PARTITION (DATA_DATE)  
SELECT 
    X.COD_CONT, X.IDF_CTO, X.COD_ACCO_CENT, X.COD_OFFI, X.DES_OFFI, X.COD_EXPENSE, X.COD_BLCE_STATUS, X.COD_CURRENCY, X.COD_ENTITY, 
    ...
    CAST(ROUND(X.INI_AM_RPT, 10) AS decimal(30, 10)) AS INI_AM_RPT, 
    ...
    CAST(ROUND(X.CREDIT_LIM_AM, 10) AS decimal(30, 10)) AS CREDIT_LIM_AM, X.PREDEF_RATE_IND, CAST(ROUND(X.PREDEF_RATE, 10) AS decimal(30, 10)) AS PREDEF_RATE, X.IND_CHANNEL, X.COD_GL_GROUP, 
    ...
    CAST(NULL AS DECIMAL (30,10)) AS AVGBAL_TOT_YTD, 
    CAST(NULL AS DECIMAL (30,10)) AS PL_YTD,
    CAST(NULL AS DECIMAL (30,10)) AS FTP_RESULT_YTD,
    CAST(NULL AS DECIMAL (30,10)) AS PL_TOT_YTD, 
    CAST(NULL AS DECIMAL (30,10)) AS AVGBAL_TOT_YTD_RPT, 
    CAST(NULL AS DECIMAL (30,10)) AS PL_YTD_RPT, 
    CAST(NULL AS DECIMAL (30,10)) AS FTP_RESULT_YTD_RPT,
    CAST(NULL AS DECIMAL (30,10)) AS PL_TOT_YTD_RPT, 
X.EXP_TYPE, X.EXP_FAMILY, X.COD_VALUE, X.COU_CAR_OFF, X.COD_CONV, X.DES_CONV, X.ID_ECO_GRO, X.COU_ECO_GRO, X.DES_ECO_GRO, X.IND_MUL_LAT, 
    X.DES_MUL_LAT, X.COD_EXEC_CTO, X.COD_COVID_PORT,
    X.FIELD1_CTO, X.FIELD2_CTO, X.FIELD3_CTO, X.FIELD4_CTO, X.FIELD5_CTO, X.FIELD6_CTO, X.FIELD7_CTO, X.FIELD8_CTO, X.FIELD9_CTO, X.FIELD10_CTO, X.FIELD1_CLI, X.FIELD2_CLI, 
    X.FIELD3_CLI, X.FIELD4_CLI, X.FIELD5_CLI, X.FIELD6_CLI, X.FIELD7_CLI, X.FIELD8_CLI, X.FIELD9_CLI, X.FIELD10_CLI,
    ...
    X.COD_SECTOR_LOCAL,X.DES_SECTOR_LOCAL,X.COD_SECTOR_REG,X.DES_SECTOR_REG, X.DATE_DISB, X.CARD_NUMBER, X.COD_METHOD_FTP, X.ID_ECO_GRO_REG, 
    X.DES_ECO_GRO_REG, CAST(ROUND(SUM(X.FTP_RESULT_USD), 10) AS decimal(30, 10)) AS FTP_RESULT_USD,  
    CAST(ROUND(SUM(X.FTP_RESULT_REG), 10) AS decimal(30, 10)) AS FTP_RESULT_REG, X.COD_PROG_CARD, X.DES_PROG_CARD,  
    X.COD_ACT_TYPE, X.DATA_DATE 
FROM
    (SELECT 
        A.COD_CONT, A.IDF_CTO, A.COD_ACCO_CENT, A.COD_OFFI, A.DES_OFFI, A.COD_EXPENSE, A.COD_BLCE_STATUS, A.COD_CURRENCY, A.COD_ENTITY, 
        ...
        A.COD_UNI_FRE_REV_INT, A.AMRT_TRM, A.COD_UNI_AMRT_TRM, A.INI_AM, 
        A.INI_AM_RPT, A.INI_AM_USD, A.INI_AM_REG,
        A.CUO_AM, A.CREDIT_LIM_AM, 
        A.PREDEF_RATE_IND, A.PREDEF_RATE, A.IND_CHANNEL, A.COD_GL_GROUP, A.DES_GL_GROUP, A.ACCOUNT_CONCEPT, 
        A.COD_PL_ACC, A.DES_PL_ACC, A.COD_BLCE_PROD, A.DES_BLCE_PROD, A.COD_BUSINESS_LINE, A.DES_BUSINESS_LINE,
...
*/
        ...
        CAST(NULL AS DECIMAL (30,10))  AS PL_TOT_YTD_RPT, A.EXP_TYPE, A.EXP_FAMILY, A.COD_VALUE, A.COU_CAR_OFF, A.COD_CONV, A.DES_CONV, A.ID_ECO_GRO, A.COU_ECO_GRO, A.DES_ECO_GRO, A.IND_MUL_LAT, A.DES_MUL_LAT, A.COD_EXEC_CTO, A.COD_COVID_PORT, A.FIELD1_CTO, A.FIELD2_CTO, A.FIELD3_CTO, A.FIELD4_CTO, A.FIELD5_CTO, A.FIELD6_CTO, A.FIELD7_CTO, A.FIELD8_CTO, A.FIELD9_CTO, A.FIELD10_CTO, A.FIELD1_CLI, A.FIELD2_CLI, A.FIELD3_CLI, A.FIELD4_CLI, A.FIELD5_CLI, A.FIELD6_CLI, A.FIELD7_CLI, A.FIELD8_CLI, A.FIELD9_CLI, A.FIELD10_CLI, 
        SUM(PL_TOT_USD) AS PL_TOT_USD,
        SUM(PL_TOT_REG) AS PL_TOT_REG,       
        SUM(EOPBAL_TOT_USD) AS EOPBAL_TOT_USD,
        SUM(EOPBAL_TOT_REG) AS EOPBAL_TOT_REG,
        SUM(AVGBAL_TOT_USD) AS AVGBAL_TOT_USD,
        SUM(AVGBAL_TOT_REG) AS AVGBAL_TOT_REG,
A.COD_SECTOR_LOCAL, A.DES_SECTOR_LOCAL,A.COD_SECTOR_REG, A.DES_SECTOR_REG, A.DATE_DISB, A.CARD_NUMBER, A.COD_METHOD_FTP, A.ID_ECO_GRO_REG, A.DES_ECO_GRO_REG,
        SUM(FTP_RESULT_USD) AS FTP_RESULT_USD,
        SUM(FTP_RESULT_REG) AS FTP_RESULT_REG,
A.COD_PROG_CARD, A.DES_PROG_CARD, A.COD_ACT_TYPE, A.DATA_DATE
    FROM MIS_TMP_DM_BALANCE_RESULT AS A 
    LEFT JOIN MIS_PAR_EXCH_RATE b   
        ON a.DATA_DATE=b.DATA_DATE AND b.COD_CONT = 'TC_FOTO' AND b.COD_CURRENCY = 'USD' 
        AND IF(ISNULL(TRIM(b.COD_ENTITY),'') = '' ,'1',A.COD_ENTITY) = IF(ISNULL(TRIM(b.COD_ENTITY),'') = '','1',b.COD_ENTITY)
GROUP BY A.DATA_DATE, A.COD_CONT, A.IDF_CTO, A.COD_ACCO_CENT, A.COD_OFFI, A.DES_OFFI, A.COD_EXPENSE, A.COD_BLCE_STATUS, A.COD_CURRENCY, A.COD_ENTITY, A.COD_PRODUCT, A.COD_SUBPRODUCT, A.COD_INFO_SOURCE, A.COD_TYP_FEE, A.IDF_CLI,
    ...
    A.IND_CHANNEL, A.COD_GL_GROUP, A.DES_GL_GROUP, A.ACCOUNT_CONCEPT, A.COD_PL_ACC, A.DES_PL_ACC, A.COD_BLCE_PROD, A.DES_BLCE_PROD, A.COD_BUSINESS_LINE, A.DES_BUSINESS_LINE, A.IND_POOL, A.EXP_TYPE, A.EXP_FAMILY, A.COD_VALUE, A.COU_CAR_OFF, A.COD_CONV, A.DES_CONV, A.ID_ECO_GRO, A.COU_ECO_GRO, A.DES_ECO_GRO, A.IND_MUL_LAT, A.DES_MUL_LAT, A.COD_EXEC_CTO, A.COD_COVID_PORT, A.FIELD1_CTO, A.FIELD2_CTO, A.FIELD3_CTO, A.FIELD4_CTO, A.FIELD5_CTO, A.FIELD6_CTO, A.FIELD7_CTO, A.FIELD8_CTO, A.FIELD9_CTO, A.FIELD10_CTO, A.FIELD1_CLI, A.FIELD2_CLI, A.FIELD3_CLI, A.FIELD4_CLI, A.FIELD5_CLI, A.FIELD6_CLI, A.FIELD7_CLI, A.FIELD8_CLI, A.FIELD9_CLI, A.FIELD10_CLI,
    A.COD_SECTOR_LOCAL,  A.DES_SECTOR_LOCAL, A.COD_SECTOR_REG, A.DES_SECTOR_REG, A.DATE_DISB, A.CARD_NUMBER, A.COD_METHOD_FTP, A.ID_ECO_GRO_REG, A.DES_ECO_GRO_REG, A.COD_PROG_CARD, A.DES_PROG_CARD, A.COD_ACT_TYPE
) X 
GROUP BY X.DATA_DATE, X.COD_CONT, X.IDF_CTO, X.COD_ACCO_CENT, X.COD_OFFI, X.DES_OFFI, X.COD_EXPENSE, X.COD_BLCE_STATUS, X.COD_CURRENCY, X.COD_ENTITY, X.COD_PRODUCT, X.COD_SUBPRODUCT, X.COD_INFO_SOURCE, X.COD_TYP_FEE, X.IDF_CLI, 
...
X.DATE_PRX_REV, X.EXP_DATE, X.FREQ_INT_PAY, X.COD_UNI_FREQ_INT_PAY, X.FRE_REV_INT, X.COD_UNI_FRE_REV_INT, X.AMRT_TRM, X.COD_UNI_AMRT_TRM, X.INI_AM, X.INI_AM_RPT, X.INI_AM_USD, X.INI_AM_REG, X.CUO_AM, X.CREDIT_LIM_AM, X.PREDEF_RATE_IND, X.PREDEF_RATE, X.IND_CHANNEL, X.COD_GL_GROUP, X.DES_GL_GROUP, X.ACCOUNT_CONCEPT, X.COD_PL_ACC, X.DES_PL_ACC, X.COD_BLCE_PROD, X.DES_BLCE_PROD, X.COD_BUSINESS_LINE, X.DES_BUSINESS_LINE, X.IND_POOL, X.EXP_TYPE, X.EXP_FAMILY, X.COD_VALUE, X.COU_CAR_OFF, X.COD_CONV, X.DES_CONV, X.ID_ECO_GRO, X.COU_ECO_GRO, X.DES_ECO_GRO, X.IND_MUL_LAT, X.DES_MUL_LAT, X.COD_EXEC_CTO, X.COD_COVID_PORT, X.FIELD1_CTO, X.FIELD2_CTO, X.FIELD3_CTO, X.FIELD4_CTO, X.FIELD5_CTO, X.FIELD6_CTO, X.FIELD7_CTO, X.FIELD8_CTO, X.FIELD9_CTO, X.FIELD10_CTO, X.FIELD1_CLI, X.FIELD2_CLI, X.FIELD3_CLI, X.FIELD4_CLI, X.FIELD5_CLI, X.FIELD6_CLI, X.FIELD7_CLI, X.FIELD8_CLI, X.FIELD9_CLI, X.FIELD10_CLI,
X.COD_SECTOR_LOCAL,  X.DES_SECTOR_LOCAL,X.COD_SECTOR_REG,X.DES_SECTOR_REG, X.DATE_DISB, X.CARD_NUMBER, X.COD_METHOD_FTP, X.ID_ECO_GRO_REG, X.DES_ECO_GRO_REG, X.COD_PROG_CARD, X.DES_PROG_CARD, X.COD_ACT_TYPE
;
...
SELECT '001' AS COD_VALID, CONCAT(COD_BLCE_PROD, " |", COD_BLCE_STATUS, "| ", COD_CURRENCY) AS CAMPOS, COD_CONT 
FROM 
...
FROM
    (SELECT DISTINCT(SALIDA_DM.COD_PL_ACC) COD_PL_ACC, SALIDA_DM.COD_CONT
    FROM
        (SELECT DM.* 
        FROM MIS_DM_BALANCE_RESULT DM
        WHERE DM.DATA_DATE='${var:periodo}') SALIDA_DM
