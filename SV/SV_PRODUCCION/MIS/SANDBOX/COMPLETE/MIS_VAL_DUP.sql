...
insert into mis_val_close_dup
select 'MIS_PAR_INTER_SEG_DRI', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', cod_blce_prod, cod_driver, 'N/A', 'N/A', cod_segment, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', cast(num as int) from(
select cod_driver, cod_segment, cod_blce_prod, count(*) as num from MIS_PAR_INTER_SEG_DRI
group by cod_driver, cod_segment, cod_blce_prod
having count(*) > 1
)a;

insert into mis_val_close_dup
select 'MIS_PAR_INTER_SEG_ENG', cod_entity, 'N/A', 'N/A', cod_currency, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', cod_gl_group, 'N/A', 'N/A', cod_acco_cent, 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', 'N/A', cast(num as int) from(
select cod_entity, cod_gl_group, cod_acco_cent, cod_currency, count(*) as num from MIS_PAR_INTER_SEG_ENG
group by cod_entity, cod_gl_group, cod_acco_cent, cod_currency
having count(*) > 1
)a;
