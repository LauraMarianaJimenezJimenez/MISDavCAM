...
SELECT 'RCTB' AS COD_CONT, A.COD_PL_ACC, PL.DES_PL_ACC, A.COD_BLCE_PROD, BP.DES_BLCE_PROD, 'UNIDAD_FONDEO' AS COD_BUSINESS_LINE, 'UNIDAD DE FONDEO' AS DES_BUSINESS_LINE, 
    'UNIDAD_FONDEO' AS COD_SEGMENT, A.COD_ENTITY, A.COD_CURRENCY, CAST(-1 * ROUND(A.FTP_RESULT, 2) AS decimal(30, 10)) AS FTP_RESULT, CAST(-1 * ROUND(A.FTP_RESULT_RPT, 2) AS decimal(30, 10)) AS FTP_RESULT_RPT, 
    CAST(-1 * ROUND(A.FTP_RESULT, 2) AS decimal(30, 10)) AS PL_TOT, CAST(-1 * ROUND(A.FTP_RESULT_RPT, 2) AS decimal(30, 10)) AS PL_TOT_RPT, 
