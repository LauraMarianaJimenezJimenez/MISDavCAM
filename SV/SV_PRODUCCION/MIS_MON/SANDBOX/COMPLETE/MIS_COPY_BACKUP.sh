...
hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_PROV_GL_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_PROV_GL.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_PROV_GL_"$YEAR$MONTH$DAY.csv

hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_COM_GL_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_COM_GL.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_COM_GL_"$YEAR$MONTH$DAY.csv

hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_PROD_SPE_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_PROD_SPE.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_PROD_SPE_"$YEAR$MONTH$DAY.csv