...
CREATE TABLE MIS_TMP_TAXES_PAR AS 
	...
	ON a.COD_GL_GROUP_DESTINY = b.COD_GL_GROUP and b.COD_CURRENCY = 'USD'
...
CREATE TABLE MIS_TMP_TAXES_PL AS
	...
	FROM 
		...
		WHERE DATA_DATE='${var:periodo}' AND (PL_TOT_RPT<>0 OR FTP_RESULT_RPT<>0) /*AND STRLEFT(a.COD_INFO_SOURCE,6) <> 'AJUSTE'*/
		) DWH
...
SELECT A.COD_ACCO_CENT, A.COD_BLCE_STATUS, 'USD' AS COD_CURRENCY, A.COD_ENTITY, A.EOPBAL_CAP, A.EOPBAL_INT, A.AVGBAL_CAP, A.AVGBAL_INT, CAST(A.PL AS DECIMAL(30,10)) AS PL, CAST(A.PL AS DECIMAL(30,10)) AS PL_TOT, 
