...
COD_INFO_SOURCE, EXP_FAMILY, EXP_TYPE, COD_VALUE, DES_GL_GROUP, DES_MANAGER, COD_SUBSEGMENT, COD_EXPENSE, DES_PRODUCT, DES_SUBPRODUCT)
PARTITION (DATA_DATE)
SELECT 
        ...
        CAST(ROUND(SUM(X.AVGBAL_TOT), 10) AS decimal(30, 10)) AS AVGBAL_TOT, CAST(ROUND(SUM(X.AVGBAL_CAP), 10) AS decimal(30, 10)) AS AVGBAL_CAP, CAST(ROUND(SUM(X.AVGBAL_INT), 10) AS decimal(30, 10)) AS AVGBAL_INT, 
        CAST(ROUND(SUM(X.PL), 10) AS decimal(30, 10)) AS PL, CAST(ROUND(SUM(X.FTP_RESULT), 10) AS decimal(30,10)) AS FTP_RESULT, CAST(ROUND(SUM(X.PL_TOT), 10) AS decimal(30, 10)) AS PL_TOT, 
        ...
        CAST(ROUND(SUM(X.PL_YTD), 10) AS decimal(30, 10)) AS PL_YTD, CAST(ROUND(SUM(X.FTP_RESULT_YTD), 10) AS decimal(30,10)) AS FTP_RESULT_YTD, CAST(ROUND(SUM(X.PL_TOT_YTD), 10) AS decimal(30, 10)) AS PL_TOT_YTD, 
        ...
        CAST(ROUND(SUM(X.PL_RPT_TRI_1), 10) AS decimal(30, 10)) AS PL_RPT_TRI_1, CAST(ROUND(SUM(X.PL_RPT_TRI_2), 10) AS decimal(30, 10)) AS PL_RPT_TRI_2, 
        CAST(ROUND(SUM(X.PL_RPT_TRI_3), 10) AS decimal(30, 10)) AS PL_RPT_TRI_3, CAST(ROUND(SUM(X.PL_RPT_TRI_4), 10) AS decimal(30, 10)) AS PL_RPT_TRI_4, 
        CAST(ROUND(SUM(X.PL_RPT_SEM_1), 10) AS decimal(30, 10)) AS PL_RPT_SEM_1, CAST(ROUND(SUM(X.PL_RPT_SEM_2), 10) AS decimal(30, 10)) AS PL_RPT_SEM_2,
        CAST(ROUND(SUM(X.FTP_RESULT_YTD_RPT), 10) AS decimal(30,10)) AS FTP_RESULT_YTD_RPT, CAST(ROUND(SUM(X.PL_TOT_YTD_RPT), 10) AS decimal(30, 10)) AS PL_TOT_YTD_RPT,
        CAST(ROUND(SUM(X.PL_TOT_RPT_TRI_1), 10) AS decimal(30, 10)) AS PL_TOT_RPT_TRI_1, CAST(ROUND(SUM(X.PL_TOT_RPT_TRI_2), 10) AS decimal(30, 10)) AS PL_TOT_RPT_TRI_2, 
        CAST(ROUND(SUM(X.PL_TOT_RPT_TRI_3), 10) AS decimal(30, 10)) AS PL_TOT_RPT_TRI_3, CAST(ROUND(SUM(X.PL_TOT_RPT_TRI_4), 10) AS decimal(30, 10)) AS PL_TOT_RPT_TRI_4, 
        CAST(ROUND(SUM(X.PL_TOT_RPT_SEM_1), 10) AS decimal(30, 10)) AS PL_TOT_RPT_SEM_1, CAST(ROUND(SUM(X.PL_TOT_RPT_SEM_2), 10) AS decimal(30, 10)) AS PL_TOT_RPT_SEM_2,
        CAST(ROUND(SUM(X.PL_RPT_MOB_YEAR), 10) AS decimal(30, 10)) AS PL_RPT_MOB_YEAR, CAST(ROUND(SUM(PL_TOT_RPT_MOB_YEAR), 10) AS decimal(30, 10)) AS PL_TOT_RPT_MOB_YEAR,
        CAST(ROUND(SUM(X.AVGBAL_TOT_RPT_TRI_1)/IF(CEILING(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))/3) = 1, MOD(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))-1,3)+1, 3), 2) AS decimal(30, 10)) AS AVGBAL_TOT_RPT_TRI_1, 
        CAST(ROUND(SUM(X.AVGBAL_TOT_RPT_TRI_2)/IF(CEILING(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))/3) = 2, MOD(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))-1,3)+1, 3), 2) AS decimal(30, 10)) AS AVGBAL_TOT_RPT_TRI_2, 
        CAST(ROUND(SUM(X.AVGBAL_TOT_RPT_TRI_3)/IF(CEILING(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))/3) = 3, MOD(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))-1,3)+1, 3), 2) AS decimal(30, 10)) AS AVGBAL_TOT_RPT_TRI_3, 
        CAST(ROUND(SUM(X.AVGBAL_TOT_RPT_TRI_4)/IF(CEILING(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))/3) = 4, MOD(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))-1,3)+1, 3), 2) AS decimal(30, 10)) AS AVGBAL_TOT_RPT_TRI_4, 
        CAST(ROUND(SUM(X.AVGBAL_TOT_RPT_SEM_1)/IF(CEILING(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))/6) = 1, MOD(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))-1,6)+1, 6), 2) AS decimal(30, 10)) AS AVGBAL_TOT_RPT_SEM_1, 
        CAST(ROUND(SUM(X.AVGBAL_TOT_RPT_SEM_2)/IF(CEILING(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))/6) = 2, MOD(MONTH(TO_TIMESTAMP(X.DATA_DATE, 'yyyyMMdd'))-1,6)+1, 6), 2) AS decimal(30, 10)) AS AVGBAL_TOT_RPT_SEM_2,     
        CAST(ROUND(SUM(X.PL_YTD_USD), 10) AS decimal(30, 10)) AS PL_YTD_USD,
        CAST(ROUND(SUM(X.PL_USD), 10) AS decimal(30, 10)) AS PL_USD,
        ...
        CAST(ROUND(IF(SUM(X.PL_TOT_RPT)=0,0,SUM(X.PL_TOT_YTD_RPT) - SUM(X.PL_TOT_YTD_REG_ANT)), 10) AS decimal(30, 10)) AS PL_TOT_REG,
        ...
        X.COD_INFO_SOURCE, X.EXP_FAMILY, X.EXP_TYPE, X.COD_VALUE, X.DES_GL_GROUP, X.DES_MANAGER, X.COD_SUBSEGMENT, 
        X.COD_EXPENSE, X.DES_PRODUCT, X.DES_SUBPRODUCT, X.DATA_DATE
    FROM
        (SELECT 
            ...
            SUM(A.PL) AS PL, SUM(A.FTP) AS FTP, SUM(A.FTP_RESULT) AS FTP_RESULT, SUM(A.PL_TOT) AS PL_TOT, 
            SUM(A.EOPBAL_TOT_RPT) AS EOPBAL_TOT_RPT, SUM(A.AVGBAL_TOT_RPT) AS AVGBAL_TOT_RPT, 
            SUM(A.PL_TOT_RPT) AS PL_TOT_RPT, SUM(A.PL_RPT) AS PL_RPT, SUM(A.FTP_RESULT_RPT) AS FTP_RESULT_RPT,
            SUM(A.AVGBAL_TOT) AS AVGBAL_TOT_YTD,
            SUM(A.PL) AS PL_YTD, SUM(A.FTP_RESULT) AS FTP_RESULT_YTD, SUM(A.PL_TOT) AS PL_TOT_YTD, 
            SUM(A.AVGBAL_TOT_RPT) AS AVGBAL_TOT_YTD_RPT, 
            SUM(A.PL_RPT) AS PL_YTD_RPT, SUM(A.FTP_RESULT_RPT) AS FTP_RESULT_YTD_RPT, SUM(A.PL_TOT_RPT) AS PL_TOT_YTD_RPT,
            ...
            A.COD_INFO_SOURCE, A.EXP_FAMILY, A.EXP_TYPE, A.COD_VALUE, 
            A.DES_GL_GROUP, A.DES_MANAGER, A.COD_SUBSEGMENT, A.COD_EXPENSE, A.DES_PRODUCT, A.DES_SUBPRODUCT, A.DATA_DATE
        ...
        ON c.DATA_DATE = '${var:periodo}' AND b.COD_CONT = 'TC_FOTO' AND c.COD_CURRENCY = 'USD' -- deberia ser PROMEDIO
        ...
        A.COD_SEGMENT, A.DES_SEGMENT, A.COD_MANAGER, A.COD_GL_GROUP, A.COD_PL_ACC, A.COD_BLCE_PROD, A.COD_BUSINESS_LINE, A.IND_POOL, 
        A.COD_SECTOR_LOCAL,A.DES_SECTOR_LOCAL,A.COD_SECTOR_REG,A.DES_SECTOR_REG,A.COD_OFFI,A.DES_OFFI,A.COD_INFO_SOURCE, A.EXP_FAMILY, A.EXP_TYPE, A.COD_VALUE, A.DES_GL_GROUP, A.DES_MANAGER, A.COD_SUBSEGMENT, A.COD_EXPENSE, A.DES_PRODUCT, A.DES_SUBPRODUCT, A.DATA_DATE
    UNION ALL 
        SELECT 
            A.COD_CONT, A.COD_ACCO_CENT, A.COD_BLCE_STATUS, A.COD_CURRENCY, A.COD_ENTITY, A.COD_PRODUCT, A.COD_SUBPRODUCT, 
            A.COD_SEGMENT, A.DES_SEGMENT, A.COD_MANAGER, A.COD_GL_GROUP, A.COD_PL_ACC, A.COD_BLCE_PROD, A.COD_BUSINESS_LINE, A.IND_POOL, 
     ...
     SUM(IF(YEAR(TO_TIMESTAMP(A.DATA_DATE, 'yyyyMMdd'))=YEAR(TO_TIMESTAMP('${var:periodo}', 'yyyyMMdd')), A.PL_RPT/b.EXCH_RATE, 0)) AS PL_YTD_USD, 
            ...
            SUM(IF(YEAR(TO_TIMESTAMP(A.DATA_DATE, 'yyyyMMdd'))=YEAR(TO_TIMESTAMP('${var:periodo}', 'yyyyMMdd')), A.PL_TOT_RPT/b.EXCH_RATE, 0)) AS PL_TOT_YTD_USD, 
...
CAST(SUM(IF(YEAR(TO_TIMESTAMP(A.DATA_DATE, 'yyyyMMdd'))=YEAR(TO_TIMESTAMP('20230331', 'yyyyMMdd'))
            AND MONTH(TO_TIMESTAMP(A.DATA_DATE, 'yyyyMMdd'))=MONTH(ADD_MONTHS(TO_TIMESTAMP('20230331', 'yyyyMMdd'),-1)), PL_TOT_YTD_REG, 0)) AS DECIMAL(30,10)) AS PL_TOT_YTD_REG_ANT, 
        ...
        GROUP BY A.COD_CONT, A.COD_ACCO_CENT, A.COD_BLCE_STATUS, A.COD_CURRENCY, A.COD_ENTITY, A.COD_PRODUCT, A.COD_SUBPRODUCT, 
        A.COD_SEGMENT, A.DES_SEGMENT, A.COD_MANAGER, A.COD_GL_GROUP, A.COD_PL_ACC, A.COD_BLCE_PROD, A.COD_BUSINESS_LINE, A.IND_POOL, 
        A.COD_SECTOR_LOCAL,A.DES_SECTOR_LOCAL,A.COD_SECTOR_REG,A.DES_SECTOR_REG,A.COD_OFFI,A.DES_OFFI,A.COD_INFO_SOURCE, A.EXP_FAMILY, A.EXP_TYPE, A.COD_VALUE, A.DES_GL_GROUP, A.DES_MANAGER, A.COD_SUBSEGMENT, A.COD_EXPENSE, A.DES_PRODUCT, A.DES_SUBPRODUCT
    ) X 
    GROUP BY X.COD_CONT, X.COD_ACCO_CENT, X.COD_BLCE_STATUS, X.COD_CURRENCY, X.COD_ENTITY, X.COD_PRODUCT, X.COD_SUBPRODUCT, 
    X.COD_SEGMENT, X.DES_SEGMENT, X.COD_MANAGER, X.COD_GL_GROUP, X.COD_PL_ACC, X.COD_BLCE_PROD, X.COD_BUSINESS_LINE, X.IND_POOL, 
    X.COD_SECTOR_LOCAL,X.DES_SECTOR_LOCAL,X.COD_SECTOR_REG,X.DES_SECTOR_REG,X.COD_OFFI, X.DES_OFFI,X.COD_INFO_SOURCE, X.EXP_FAMILY, X.EXP_TYPE, X.COD_VALUE, X.DES_GL_GROUP, X.DES_MANAGER, X.COD_SUBSEGMENT, X.COD_EXPENSE, X.DES_PRODUCT, X.DES_SUBPRODUCT, X.DATA_DATE
;