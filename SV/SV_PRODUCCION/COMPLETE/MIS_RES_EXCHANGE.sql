...
INSERT INTO MIS_DM_BALANCE_RESULT_AUX_M
    (COD_CONT, IDF_CTO, COD_ACCO_CENT, COD_BLCE_STATUS, COD_CURRENCY, COD_ENTITY, COD_PRODUCT, COD_SUBPRODUCT, 
    EOPBAL_CAP, EOPBAL_INT, AVGBAL_CAP, AVGBAL_INT, PL, COD_INFO_SOURCE, COD_GL_GROUP, DES_GL_GROUP, ACCOUNT_CONCEPT, 
...
PARTITION (DATA_DATE)
SELECT 
    a.COD_CONT, a.IDF_CTO, a.COD_ACCO_CENT, a.COD_BLCE_STATUS, a.COD_CURRENCY, a.COD_ENTITY, a.COD_PRODUCT, a.COD_SUBPRODUCT, 
    a.EOPBAL_CAP, a.EOPBAL_INT, a.AVGBAL_CAP, a.AVGBAL_INT, a.PL, a.COD_INFO_SOURCE, a.COD_GL_GROUP, a.DES_GL_GROUP, a.ACCOUNT_CONCEPT, 
...
INSERT INTO MIS_DM_BALANCE_RESULT_AUX_M 
    ...
    EOPBAL_CAP, EOPBAL_INT, AVGBAL_CAP, AVGBAL_INT, PL, COD_INFO_SOURCE, COD_GL_GROUP, DES_GL_GROUP, ACCOUNT_CONCEPT, 
    COD_PL_ACC, DES_PL_ACC, COD_BLCE_PROD, DES_BLCE_PROD, COD_BUSINESS_LINE, DES_BUSINESS_LINE, COD_VALUE,
    FTP, FTP_RESULT, IND_POOL, EOPBAL_TOT, AVGBAL_TOT, PL_TOT, COD_SEGMENT)
PARTITION (DATA_DATE)
SELECT 
      a.CONTENIDO, CAST(CAST(a.CONTRATO AS BIGINT) AS STRING), a.CENTRO_CONTABLE, '1' AS COD_BLCE_STATUS, a.DIVISA, a.ENTIDAD, 'MAN_ADJ' AS 
      COD_PRODUCT, 'OPER' AS COD_SUBPRODUCT, a.IMPORTE_ML, 0 AS EOPBAL_INT, a.SALDO_MEDIO_ML, 0 AS AVGBAL_INT, a.PL_ML, 'ADJ_OPER' AS 
      COD_INFO_SOURCE, a.AGRUPADOR_CONTABLE, b.DES_GL_GROUP AS DES_GL_GROUP, b.ACCOUNT_CONCEPT AS ACCOUNT_CONCEPT, 
      a.CUENTA_PG, NULL AS DES_PL_ACC, a.PRODUCTO_BALANCE, NULL AS DES_BLCE_PROD, a.LINEA_DE_NEGOCIO, NULL AS DES_BUSINESS_LINE, NULL AS 
      COD_VALUE, NULL AS FTP, NULL AS FTP_RESULT, NULL AS IND_POOL,
      ...
      CAST(IFNULL(a.PL_MO, a.PL_ML) AS decimal(30, 10))  AS PL_TOT, a.COD_SEGMENT,
      a.DATA_DATE
FROM MIS_DWH_MANUAL_ADJ_OPER a
LEFT JOIN MIS_PAR_CAT_CAF b
on a.ENTIDAD = b.COD_ENTITY and a.DIVISA = b.COD_CURRENCY and a.AGRUPADOR_CONTABLE = b.COD_GL_GROUP
WHERE a.DATA_DATE='${var:periodo}'; 
...
SELECT a.COD_CONT,a.IDF_CTO,a.COD_ACCO_CENT,a.COD_EXPENSE,a.COD_BLCE_STATUS,a.COD_CURRENCY,a.COD_ENTITY, a.COD_PRODUCT, a.COD_SUBPRODUCT,a.EOPBAL_TOT,a.EOPBAL_CAP,a.EOPBAL_INT,a.AVGBAL_TOT,a.AVGBAL_CAP,a.AVGBAL_INT,a.PL,a.COD_INFO_SOURCE,a.COD_TYP_FEE,
   ...
   b.DATE_PRX_REV,b.EXP_DATE,b.FREQ_INT_PAY,b.COD_UNI_FREQ_INT_PAY,b.FRE_REV_INT,b.COD_UNI_FRE_REV_INT,b.AMRT_TRM,b.COD_UNI_AMRT_TRM,
    CASE WHEN dup.COD_SUBPRODUCT IS NOT NULL THEN b.INI_AM WHEN m.COD_INFO_SOURCE LIKE '%_M' THEN 0 ELSE b.INI_AM END AS INI_AM,b.CUO_AM,b.CREDIT_LIM_AM,b.PREDEF_RATE_IND,b.PREDEF_RATE,b.IND_CHANNEL,b.COD_OFFI,'' AS COD_SELLER,'' AS DES_SELLER,
    ...
    a.FTP,a.FTP_RESULT,a.IND_POOL, CASE WHEN a.EXP_TYPE IS NOT NULL THEN a.EXP_TYPE WHEN AL4.EXP_TYPE IS NOT NULL THEN AL4.EXP_TYPE 
WHEN AL6.EXP_TYPE IS NOT NULL THEN AL6.EXP_TYPE 
WHEN AL7.EXP_TYPE IS NOT NULL THEN AL7.EXP_TYPE
END AS EXP_TYPE, 
CASE WHEN a.EXP_FAMILY IS NOT NULL THEN a.EXP_FAMILY        
...
END AS EXP_FAMILY, CASE WHEN b.COU_CAR_OFF IS NOT NULL THEN b.COU_CAR_OFF ELSE d.COU_CAR_OFF END AS COU_CAR_OFF, CASE WHEN CAST(CAST(b.COD_CONV AS BIGINT) AS STRING) IS NOT NULL THEN CAST(CAST(b.COD_CONV AS BIGINT) AS STRING) ELSE CAST(CAST(d.COD_CONV AS BIGINT) AS STRING) END AS COD_CONV, g.DES_CONV, CASE WHEN c.ID_ECO_GRO IS NOT NULL THEN c.ID_ECO_GRO ELSE e.ID_ECO_GRO END AS ID_ECO_GRO, CASE WHEN c.COU_ECO_GRO IS NOT NULL THEN c.COU_ECO_GRO ELSE e.COU_ECO_GRO END AS COU_ECO_GRO, f.DES_ECO_GRO, CASE WHEN c.IND_MUL_LAT IS NOT NULL THEN c.IND_MUL_LAT ELSE e.IND_MUL_LAT END AS IND_MUL_LAT, h.DES_MUL_LAT, b.COD_EXEC_CTO, b.COD_COVID_PORT, b.FIELD1_CTO, b.FIELD2_CTO, 
    b.FIELD3_CTO, b.FIELD4_CTO, b.FIELD5_CTO, b.FIELD6_CTO, b.FIELD7_CTO, b.FIELD8_CTO, b.FIELD9_CTO, b.FIELD10_CTO, c.FIELD1_CLI, c.FIELD2_CLI, c.FIELD3_CLI, c.FIELD4_CLI, c.FIELD5_CLI, c.FIELD6_CLI, c.FIELD7_CLI, 
    c.FIELD8_CLI, c.FIELD9_CLI, 
c.FIELD10_CLI, 
i.COD_SECTOR_LOCAL,  i.DES_SECTOR_LOCAL, i.COD_SECTOR_REG, i.DES_SECTOR_REG, 
    CASE WHEN a.COD_INFO_SOURCE in ('ADJ_ADD','ADJ_IMP','ADJ_TITU', 'TAR_ADICIONAL') THEN a.DATE_DISB 
         WHEN l.DATE_DISB IS NOT NULL THEN l.DATE_DISB
         WHEN l.DATE_DISB IS NULL AND b.CARD_NUMBER IS NOT NULL THEN b.DATE_DISB 
    ELSE b.DATE_ORIGIN END AS DATE_DISB, 
    CASE WHEN a.COD_INFO_SOURCE in ('ADJ_ADD', 'ADJ_IMP', 'ADJ_TITU') THEN a.CARD_NUMBER ELSE b.CARD_NUMBER END AS CARD_NUMBER,
a.COD_METHOD_FTP, a.COD_DRIVER, a.COD_ACCO_CENT_ORIGIN, 
a.COD_EXPENSE_ORIGIN, j.ID_ECO_GRO_REG, k.DES_ECO_GRO_REG, b.COD_PROG_CARD, n.DES_PROG_CARD, a.COD_ACT_TYPE, a.DATA_DATE, o.DES_PRODUCT, p.DES_SUBPRODUCT
...
LEFT JOIN (SELECT IDF_CLI, CAST(IDF_CTO AS BIGINT) AS IDF_CTO, MAX(ID_ECO_GRO) AS ID_ECO_GRO, MAX(COU_ECO_GRO) AS COU_ECO_GRO, MAX(IND_MUL_LAT) AS IND_MUL_LAT, MAX(COU_CAR_OFF) AS COU_CAR_OFF, CAST(MAX(CAST(COD_CONV AS BIGINT)) AS STRING) AS COD_CONV FROM MIS_PAR_REL_REG_DIMENSIONS_COD_CONV WHERE DATA_DATE = '${var:periodo}' GROUP BY IDF_CLI, CAST(IDF_CTO AS BIGINT)) d 
ON IF(TRIM(CAST(a.IDF_CTO AS STRING))='','NA',CAST(a.IDF_CTO AS STRING)) = CAST(d.IDF_CTO AS STRING) 
...
ON CAST(d.COD_CONV AS BIGINT) = CAST(g.COD_CONV as BIGINT)
LEFT JOIN MIS_PAR_CAT_MUL_LAT h 
ON e.IND_MUL_LAT = h.IND_MUL_LAT
LEFT JOIN MIS_PAR_CAT_SECTOR_ECO i
ON c.COD_SECTOR_LOCAL = i.COD_SECTOR_LOCAL
LEFT JOIN MIS_PAR_REL_EXP_TYP AL4   
ON TRIM(AL4.COD_EXPENSE) = '' AND a.COD_ACCO_CENT=AL4.COD_ACCO_CENT AND a.COD_GL_GROUP=AL4.COD_GL_GROUP 
LEFT JOIN MIS_PAR_REL_EXP_TYP AL6   
ON COALESCE(AL4.EXP_FAMILY) IS NULL AND TRIM(AL6.COD_EXPENSE) = '' AND a.COD_ACCO_CENT=AL6.COD_ACCO_CENT AND TRIM(AL6.COD_GL_GROUP) = ''    
LEFT JOIN MIS_PAR_REL_EXP_TYP AL7   
ON COALESCE(AL4.EXP_FAMILY, AL6.EXP_FAMILY) IS NULL 
AND TRIM(AL7.COD_EXPENSE) = '' AND TRIM(AL7.COD_ACCO_CENT) = '' AND a.COD_GL_GROUP=AL7.COD_GL_GROUP 
...
LEFT JOIN (SELECT * FROM MIS_DWH_MANUAL_ADJ_OPER_ADD_CRED_CARD WHERE CRITERIO_DE_AJUSTE = 'ADJ_DATE' AND DATA_DATE = '${var:periodo}') l
ON l.CARD_NUMBER = b.CARD_NUMBER
LEFT JOIN MIS_PAR_CAT_PROG_CARD n
ON b.COD_PROG_CARD = n.COD_PROG_CARD
LEFT JOIN MIS_PAR_CAT_PRODUCT o
ON SPLIT_PART(a.COD_PRODUCT,'_',1) = o.COD_PRODUCT
LEFT JOIN MIS_PAR_CAT_SUBPRODUCT p
ON SPLIT_PART(a.COD_SUBPRODUCT,'_',1) = p.COD_SUBPRODUCT AND a.COD_ENTITY = p.COD_ENTITY
;
...
SELECT a.COD_CONT,a.IDF_CTO,a.COD_ACCO_CENT,a.COD_OFFI, c.DES_OFFI, a.COD_EXPENSE,a.COD_BLCE_STATUS,a.COD_CURRENCY,a.COD_ENTITY,a.EXP_TYPE,a.EXP_FAMILY,     a.COD_PRODUCT,a.COD_SUBPRODUCT,a.EOPBAL_TOT,a.EOPBAL_CAP,a.EOPBAL_INT,a.AVGBAL_TOT,a.AVGBAL_CAP,a.AVGBAL_INT,a.PL,a.COD_INFO_SOURCE,a.COD_TYP_FEE,
    a.IDF_CLI,a.TYP_DOC_ID,a.NUM_DOC_ID,a.NOM_NAME,a.NOM_LASTN,a.COD_RES_COUNT,a.COD_TYP_CLNT,a.COD_COND_CLNT,
    a.COD_ENG,a.VAL_SEX,a.COD_SEGMENT,a.DES_SEGMENT,a.COD_SUBSEGMENT,a.DES_SUBSEGMENT,a.IND_EMPL_GRUP,a.DATE_CLNT_REG,a.DATE_CLNT_WITHDRAW,
    ...
    a.PL_TOT,a.AVGBAL_TOT_YTD,a.PL_YTD,a.FTP_RESULT_YTD,a.PL_TOT_YTD,
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.EOPBAL_TOT, 0) 
        ELSE IFNULL(a.EOPBAL_TOT * b.EXCH_RATE, 0) END AS EOPBAL_TOT_RPT,
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.AVGBAL_TOT, 0) 
        ELSE IFNULL(a.AVGBAL_TOT * b.EXCH_RATE,0) END AS AVGBAL_TOT_RPT,
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.PL_TOT, 0)
        ELSE IFNULL(a.PL_TOT  * b.EXCH_RATE,0) END AS PL_TOT_RPT,
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.PL, 0)
        ELSE IFNULL(a.PL  * b.EXCH_RATE,0) END AS PL_RPT,
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.FTP_RESULT, 0)
        ELSE IFNULL(a.FTP_RESULT  * b.EXCH_RATE,0) END AS FTP_RESULT_RPT,
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.AVGBAL_TOT_YTD, 0) 
        ELSE IFNULL(a.AVGBAL_TOT_YTD * b.EXCH_RATE,0) END AS AVGBAL_TOT_YTD_RPT,
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.PL_YTD, 0) 
        ELSE IFNULL(a.PL_YTD  * b.EXCH_RATE,0) END AS PL_YTD_RPT,
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.FTP_RESULT_YTD, 0) 
        ELSE IFNULL(a.FTP_RESULT_YTD  * b.EXCH_RATE,0) END AS FTP_RESULT_YTD_RPT,
    a.PL_TOT_YTD_RPT AS PL_TOT_YTD_RPT, 
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.INI_AM, 0)
        ELSE IFNULL(a.INI_AM  * b.EXCH_RATE,0) END AS INI_AM_RPT,
    a.COD_GL_GROUP,a.DES_GL_GROUP,a.ACCOUNT_CONCEPT,a.COD_PL_ACC,
    a.DES_PL_ACC,a.COD_BLCE_PROD,a.DES_BLCE_PROD,a.COD_BUSINESS_LINE,a.DES_BUSINESS_LINE,a.COD_VALUE, A.COU_CAR_OFF, A.COD_CONV, A.DES_CONV, A.ID_ECO_GRO, A.COU_ECO_GRO, A.DES_ECO_GRO, A.IND_MUL_LAT, A.DES_MUL_LAT, A.COD_EXEC_CTO, A.COD_COVID_PORT, A.FIELD1_CTO, A.FIELD2_CTO, 
    A.FIELD3_CTO, A.FIELD4_CTO, A.FIELD5_CTO, A.FIELD6_CTO, A.FIELD7_CTO, A.FIELD8_CTO, A.FIELD9_CTO, A.FIELD10_CTO, A.FIELD1_CLI, A.FIELD2_CLI, A.FIELD3_CLI, A.FIELD4_CLI, A.FIELD5_CLI, A.FIELD6_CLI, A.FIELD7_CLI, 
    A.FIELD8_CLI, A.FIELD9_CLI, A.FIELD10_CLI,A.COD_SECTOR_LOCAL, A.DES_SECTOR_LOCAL,  A.COD_SECTOR_REG, A.DES_SECTOR_REG, a.DATE_DISB, 
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.EOPBAL_TOT, 0) 
        ELSE IFNULL(a.EOPBAL_TOT * b.EXCH_RATE, 0) END AS EOPBAL_TOT_USD,
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.EOPBAL_TOT, 0) 
        ELSE IFNULL(a.EOPBAL_TOT * b.EXCH_RATE, 0) END AS EOPBAL_TOT_REG,
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.PL_TOT, 0)
        ELSE IFNULL(a.PL_TOT  * b.EXCH_RATE,0) END AS PL_TOT_USD,
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.PL_TOT, 0)
        ELSE IFNULL(a.PL_TOT  * b.EXCH_RATE,0) END AS PL_TOT_REG,
     CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.AVGBAL_TOT, 0) 
        ELSE IFNULL(a.AVGBAL_TOT * b.EXCH_RATE,0) END AS AVGBAL_TOT_USD,
    CASE 
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.AVGBAL_TOT, 0) 
        ELSE IFNULL(a.AVGBAL_TOT * b.EXCH_RATE,0) END AS AVGBAL_TOT_REG,
    a.CARD_NUMBER, a.FTP, a.FTP_RESULT, a.IND_POOL, a.COD_METHOD_FTP,
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.FTP_RESULT, 0)
        ELSE IFNULL(a.FTP_RESULT  * b.EXCH_RATE,0) END AS FTP_RESULT_USD,
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.FTP_RESULT, 0)
        ELSE IFNULL(a.FTP_RESULT  * b.EXCH_RATE,0) END AS FTP_RESULT_REG,
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.INI_AM, 0)
        ELSE IFNULL(a.INI_AM * b.EXCH_RATE,0) END AS INI_AM_USD,
    CASE
        WHEN a.COD_CURRENCY='USD' THEN IFNULL(a.INI_AM, 0)
        ELSE IFNULL(a.INI_AM * b.EXCH_RATE,0) END AS INI_AM_REG,
    a.COD_DRIVER, a.COD_ACCO_CENT_ORIGIN, a.COD_EXPENSE_ORIGIN, a.ID_ECO_GRO_REG, a.DES_ECO_GRO_REG, 
    a.COD_PROG_CARD, a.DES_PROG_CARD, a.COD_ACT_TYPE, a.DATA_DATE, a.DES_PRODUCT, a.DES_SUBPRODUCT
...
(COD_CONT,IDF_CTO,COD_ACCO_CENT,COD_EXPENSE,COD_BLCE_STATUS,COD_CURRENCY,COD_ENTITY,COD_PRODUCT,COD_SUBPRODUCT,
COD_TYP_FEE,IDF_CLI,TYP_DOC_ID,NUM_DOC_ID,NOM_NAME,NOM_LASTN,COD_RES_COUNT,COD_TYP_CLNT,COD_COND_CLNT,COD_ENG,VAL_SEX,COD_SEGMENT,DES_SEGMENT,COD_SUBSEGMENT,DES_SUBSEGMENT,IND_EMPL_GRUP,
...
PL_TOT,EOPBAL_TOT_RPT,AVGBAL_TOT_RPT,PL_TOT_RPT,EOPBAL_TOT_USD,EOPBAL_TOT_REG,PL_TOT_USD,PL_TOT_REG,AVGBAL_TOT_USD,AVGBAL_TOT_REG,PL_RPT,FTP_RESULT_RPT, COD_OFFI, DES_OFFI, EXP_TYPE,EXP_FAMILY,COD_VALUE, COU_CAR_OFF, COD_CONV, DES_CONV, ID_ECO_GRO, COU_ECO_GRO, DES_ECO_GRO, IND_MUL_LAT, DES_MUL_LAT, COD_EXEC_CTO, COD_COVID_PORT, FIELD1_CTO, FIELD2_CTO, FIELD3_CTO, FIELD4_CTO, FIELD5_CTO, FIELD6_CTO, FIELD7_CTO, FIELD8_CTO, FIELD9_CTO, FIELD10_CTO, FIELD1_CLI, FIELD2_CLI, FIELD3_CLI, FIELD4_CLI, FIELD5_CLI, FIELD6_CLI, FIELD7_CLI, FIELD8_CLI, FIELD9_CLI, FIELD10_CLI,
COD_SECTOR_LOCAL,DES_SECTOR_LOCAL,COD_SECTOR_REG,DES_SECTOR_REG, DATE_DISB, CARD_NUMBER, COD_METHOD_FTP, FTP_RESULT_USD, FTP_RESULT_REG, COD_DRIVER, COD_ACCO_CENT_ORIGIN, COD_EXPENSE_ORIGIN, ID_ECO_GRO_REG, DES_ECO_GRO_REG, COD_PROG_CARD, DES_PROG_CARD, COD_ACT_TYPE, DES_PRODUCT, DES_SUBPRODUCT, PL_REG)
PARTITION (DATA_DATE, COD_INFO_SOURCE)  
SELECT 
    X.COD_CONT, X.IDF_CTO, X.COD_ACCO_CENT, X.COD_EXPENSE, X.COD_BLCE_STATUS, X.COD_CURRENCY, X.COD_ENTITY, 
    ...
    CAST(ROUND(X.INI_AM_USD, 10) AS decimal(30, 10)) AS INI_AM_USD, CAST(ROUND(X.INI_AM_REG, 10) AS decimal(30, 10)) AS INI_AM_REG, 
    ...
    X.COD_OFFI,
    X.DES_OFFI,X.EXP_TYPE,X.EXP_FAMILY,X.COD_VALUE, X.COU_CAR_OFF, X.COD_CONV, X.DES_CONV, X.ID_ECO_GRO, X.COU_ECO_GRO, X.DES_ECO_GRO, X.IND_MUL_LAT, X.DES_MUL_LAT, X.COD_EXEC_CTO, X.COD_COVID_PORT, X.FIELD1_CTO, X.FIELD2_CTO, X.FIELD3_CTO, X.FIELD4_CTO, X.FIELD5_CTO, X.FIELD6_CTO, X.FIELD7_CTO, X.FIELD8_CTO, X.FIELD9_CTO, X.FIELD10_CTO, X.FIELD1_CLI, X.FIELD2_CLI, X.FIELD3_CLI, X.FIELD4_CLI, X.FIELD5_CLI, X.FIELD6_CLI, X.FIELD7_CLI, X.FIELD8_CLI, X.FIELD9_CLI, X.FIELD10_CLI,
    X.COD_SECTOR_LOCAL,X.DES_SECTOR_LOCAL,X.COD_SECTOR_REG,X.DES_SECTOR_REG, X.DATE_DISB, X.CARD_NUMBER, X.COD_METHOD_FTP, 
    ...
    X.COD_DRIVER, X.COD_ACCO_CENT_ORIGIN, X.COD_EXPENSE_ORIGIN, X.ID_ECO_GRO_REG, X.DES_ECO_GRO_REG, 
    X.COD_PROG_CARD, X.DES_PROG_CARD, X.COD_ACT_TYPE, X.DES_PRODUCT, X.DES_SUBPRODUCT, 
    CAST(ROUND(SUM(X.PL_REG), 10) AS decimal(30, 10)) AS PL_REG, X.DATA_DATE, X.COD_INFO_SOURCE 
FROM
    (SELECT A.COD_CONT, A.IDF_CTO, A.COD_ACCO_CENT, A.COD_EXPENSE, A.COD_BLCE_STATUS, A.COD_CURRENCY, A.COD_ENTITY, 
        ...
        A.IND_POOL, SUM(A.EOPBAL_TOT) AS EOPBAL_TOT, SUM(A.EOPBAL_CAP) AS EOPBAL_CAP, SUM(A.EOPBAL_INT) AS EOPBAL_INT, CAST(SUM(A.AVGBAL_TOT) AS decimal(30, 10)) AS AVGBAL_TOT, 
        ...
        SUM(A.EOPBAL_TOT_RPT) AS EOPBAL_TOT_RPT, CAST(SUM(A.AVGBAL_TOT_RPT) AS decimal (30, 10)) AS AVGBAL_TOT_RPT, SUM(A.PL_TOT_RPT) AS PL_TOT_RPT, 
        SUM(A.EOPBAL_TOT_USD) AS EOPBAL_TOT_USD,
        SUM(A.EOPBAL_TOT_REG) AS EOPBAL_TOT_REG,
        SUM(A.PL_TOT_USD) AS PL_TOT_USD,
        SUM(A.PL_TOT_USD) AS PL_TOT_REG,        
        SUM(A.AVGBAL_TOT_USD) AS AVGBAL_TOT_USD,
        SUM(A.AVGBAL_TOT_USD) AS AVGBAL_TOT_REG,
        ...
        NULL AS PL_TOT_YTD, 
        CASE 
        WHEN MONTH(TO_TIMESTAMP(A.DATA_DATE, 'yyyyMMdd')) = 1 AND DAY(TO_TIMESTAMP(A.DATA_DATE, 'yyyyMMdd')) = 1 THEN CAST(SUM(A.AVGBAL_TOT_RPT) AS decimal(30, 10)) 
        ...
        A.COD_OFFI, A.DES_OFFI, A.EXP_TYPE, A.EXP_FAMILY,A.COD_VALUE, A.COU_CAR_OFF, A.COD_CONV, A.DES_CONV, A.ID_ECO_GRO, A.COU_ECO_GRO, A.DES_ECO_GRO, A.IND_MUL_LAT, A.DES_MUL_LAT, A.COD_EXEC_CTO, A.COD_COVID_PORT, A.FIELD1_CTO, A.FIELD2_CTO, A.FIELD3_CTO, A.FIELD4_CTO, A.FIELD5_CTO, A.FIELD6_CTO, A.FIELD7_CTO, A.FIELD8_CTO, A.FIELD9_CTO, A.FIELD10_CTO, A.FIELD1_CLI, A.FIELD2_CLI, A.FIELD3_CLI, A.FIELD4_CLI, A.FIELD5_CLI, A.FIELD6_CLI, A.FIELD7_CLI, A.FIELD8_CLI, A.FIELD9_CLI, A.FIELD10_CLI,
        A.COD_SECTOR_LOCAL,  A.DES_SECTOR_LOCAL, A.COD_SECTOR_REG, A.DES_SECTOR_REG, A.DATE_DISB, A.CARD_NUMBER, A.COD_METHOD_FTP, 
        SUM(A.FTP_RESULT_USD) AS FTP_RESULT_USD,
        SUM(A.FTP_RESULT_REG) AS FTP_RESULT_REG, A.COD_DRIVER, A.COD_ACCO_CENT_ORIGIN, A.COD_EXPENSE_ORIGIN, A.ID_ECO_GRO_REG, A.DES_ECO_GRO_REG, A.COD_PROG_CARD, A.DES_PROG_CARD, A.COD_ACT_TYPE, A.DES_PRODUCT, A.DES_SUBPRODUCT, 
        SUM(A.PL_RPT) AS PL_REG,
    ...
    LEFT JOIN MIS_PAR_EXCH_RATE b   
        ...
        AND IF(ISNULL(TRIM(b.COD_ENTITY),'') = '' ,'1',A.COD_ENTITY) = IF(ISNULL(TRIM(b.COD_ENTITY),'') = '','1',b.COD_ENTITY)
    GROUP BY A.DATA_DATE, A.COD_CONT, A.IDF_CTO, A.COD_ACCO_CENT, A.COD_EXPENSE, A.COD_BLCE_STATUS, A.COD_CURRENCY, A.COD_ENTITY, A.COD_PRODUCT, A.COD_SUBPRODUCT, A.COD_TYP_FEE, A.IDF_CLI,
    ...
    A.COD_OFFI, A.DES_OFFI, A.EXP_TYPE, A.EXP_FAMILY, A.COD_VALUE, A.COU_CAR_OFF, A.COD_CONV, A.DES_CONV, A.ID_ECO_GRO, A.COU_ECO_GRO, A.DES_ECO_GRO, A.IND_MUL_LAT, A.DES_MUL_LAT, A.COD_EXEC_CTO, A.COD_COVID_PORT, A.FIELD1_CTO, A.FIELD2_CTO, A.FIELD3_CTO, A.FIELD4_CTO, A.FIELD5_CTO, A.FIELD6_CTO, A.FIELD7_CTO, A.FIELD8_CTO, A.FIELD9_CTO, A.FIELD10_CTO, A.FIELD1_CLI, A.FIELD2_CLI, A.FIELD3_CLI, A.FIELD4_CLI, A.FIELD5_CLI, A.FIELD6_CLI, A.FIELD7_CLI, A.FIELD8_CLI, A.FIELD9_CLI, A.FIELD10_CLI,
    A.COD_SECTOR_LOCAL, A.DES_SECTOR_LOCAL, A.COD_SECTOR_REG, A.DES_SECTOR_REG, A.DATE_DISB, A.CARD_NUMBER, A.COD_METHOD_FTP, 
    A.COD_DRIVER, A.COD_ACCO_CENT_ORIGIN, A.COD_EXPENSE_ORIGIN, A.ID_ECO_GRO_REG, A.DES_ECO_GRO_REG, A.COD_PROG_CARD, 
    A.DES_PROG_CARD, A.COD_ACT_TYPE, A.DES_PRODUCT, A.DES_SUBPRODUCT, A.COD_INFO_SOURCE

/*UNION ALL 

    SELECT 
        A.COD_CONT, A.IDF_CTO, A.COD_ACCO_CENT, A.COD_BLCE_STATUS, A.COD_CURRENCY, A.COD_ENTITY,
        ...
        COALESCE(CLI.COD_SEGMENT, A.COD_SEGMENT) AS COD_SEGMENT, COALESCE(CLI.DES_SEGMENT, A.DES_SEGMENT) AS DES_SEGMENT, A.COD_SUBSEGMENT, A.DES_SUBSEGMENT, A.IND_EMPL_GRUP, A.DATE_CLNT_REG, A.DATE_CLNT_WITHDRAW,
        A.COD_MANAGER, A.DES_MANAGER, A.COD_SECTOR, A.DES_SECTOR, A.RATING_CLI, A.COD_GROUP_EC,
        A.COD_BCA_INT, A.COD_AMRT_MET, A.COD_RATE_TYPE, A.RATE_INT, A.DATE_ORIGIN, 
        A.DATE_LAST_REV, A.DATE_PRX_REV, A.EXP_DATE, A.FREQ_INT_PAY, A.COD_UNI_FREQ_INT_PAY, A.FRE_REV_INT, 
        ...
        NULL AS PL_TOT_YTD_RPT, A.COD_OFFI,
        A.DES_OFFI, A.EXP_TYPE, A.EXP_FAMILY, A.COD_VALUE,
    ...
    GROUP BY A.COD_CONT, A.IDF_CTO, A.COD_ACCO_CENT, A.COD_BLCE_STATUS, A.COD_CURRENCY, A.COD_ENTITY, A.COD_PRODUCT, A.COD_SUBPRODUCT, A.COD_TYP_FEE, A.IDF_CLI, A.TYP_DOC_ID,
    A.NUM_DOC_ID, A.NOM_NAME, A.NOM_LASTN, A.COD_RES_COUNT, A.COD_TYP_CLNT, A.COD_COND_CLNT, A.COD_ENG, A.VAL_SEX, COALESCE(CLI.COD_SEGMENT, A.COD_SEGMENT), COALESCE(CLI.DES_SEGMENT, A.DES_SEGMENT), A.COD_SUBSEGMENT, A.DES_SUBSEGMENT, 
    ...
    A.CREDIT_LIM_AM, A.PREDEF_RATE_IND, A.PREDEF_RATE, A.IND_CHANNEL, A.COD_SELLER, A.DES_SELLER, A.COD_GL_GROUP, A.DES_GL_GROUP, A.ACCOUNT_CONCEPT, A.COD_PL_ACC, A.DES_PL_ACC, A.COD_BLCE_PROD, A.DES_BLCE_PROD, A.COD_BUSINESS_LINE, 
    A.DES_BUSINESS_LINE, A.IND_POOL, A.COD_OFFI, A.DES_OFFI, A.EXP_TYPE, A.EXP_FAMILY, A.COD_VALUE, A.COD_INFO_SOURCE */
) X 
GROUP BY X.DATA_DATE, X.COD_CONT, X.IDF_CTO, X.COD_ACCO_CENT, X.COD_EXPENSE, X.COD_BLCE_STATUS, X.COD_CURRENCY, X.COD_ENTITY, X.COD_PRODUCT, X.COD_SUBPRODUCT, X.COD_TYP_FEE, X.IDF_CLI, 
...
X.IND_CHANNEL, X.COD_SELLER, X.DES_SELLER, X.COD_GL_GROUP, X.DES_GL_GROUP, X.ACCOUNT_CONCEPT, X.COD_PL_ACC, X.DES_PL_ACC, X.COD_BLCE_PROD, X.DES_BLCE_PROD, X.COD_BUSINESS_LINE, X.DES_BUSINESS_LINE, X.IND_POOL, X.COD_OFFI,
X.DES_OFFI, X.EXP_TYPE, X.EXP_FAMILY, X.COD_VALUE, X.COU_CAR_OFF, X.COD_CONV, X.DES_CONV, X.ID_ECO_GRO, X.COU_ECO_GRO, X.DES_ECO_GRO, X.IND_MUL_LAT, X.DES_MUL_LAT, X.COD_EXEC_CTO, X.COD_COVID_PORT, X.FIELD1_CTO, X.FIELD2_CTO, X.FIELD3_CTO, X.FIELD4_CTO, X.FIELD5_CTO, X.FIELD6_CTO, X.FIELD7_CTO, X.FIELD8_CTO, X.FIELD9_CTO, X.FIELD10_CTO, X.FIELD1_CLI, X.FIELD2_CLI, X.FIELD3_CLI, X.FIELD4_CLI, X.FIELD5_CLI, X.FIELD6_CLI, X.FIELD7_CLI, X.FIELD8_CLI, X.FIELD9_CLI, X.FIELD10_CLI,
X.COD_SECTOR_LOCAL, X.DES_SECTOR_LOCAL,  X.COD_SECTOR_REG,X.DES_SECTOR_REG, X.DATE_DISB, X.CARD_NUMBER, X.COD_METHOD_FTP, X.COD_DRIVER, X.COD_ACCO_CENT_ORIGIN, X.COD_EXPENSE_ORIGIN, X.ID_ECO_GRO_REG, X.DES_ECO_GRO_REG, X.COD_PROG_CARD, X.DES_PROG_CARD, X.COD_ACT_TYPE, X.DES_PRODUCT, X.DES_SUBPRODUCT, X.COD_INFO_SOURCE
;
