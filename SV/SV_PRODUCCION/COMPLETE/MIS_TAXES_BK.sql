...
CAST(A.PL AS DECIMAL(30,10)), CAST(A.PL AS DECIMAL(30,10)), A.COD_INFO_SOURCE, A.COD_GL_GROUP, 
...
DES_GL_GROUP, ACCOUNT_CONCEPT, COD_PL_ACC, DES_PL_ACC, COD_BLCE_PROD, DES_BLCE_PROD, COD_BUSINESS_LINE, DES_BUSINESS_LINE, IND_POOL, COD_SEGMENT, DES_SEGMENT, EXP_TYPE, EXP_FAMILY, COD_CONT) 
PARTITION(DATA_DATE)
SELECT A.COD_ACCO_CENT, A.COD_BLCE_STATUS, A.COD_CURRENCY, A.COD_ENTITY, CAST(A.EOPBAL_CAP AS DECIMAL(30,10)), CAST(A.EOPBAL_INT AS DECIMAL(30,10)), CAST(A.AVGBAL_CAP AS DECIMAL(30,10)), 
CAST(A.AVGBAL_INT AS DECIMAL(30,10)), CAST(A.PL AS DECIMAL(30,10)), CAST(A.PL AS DECIMAL(30,10)), CAST(A.PL AS DECIMAL(30,10)), CAST(A.PL AS DECIMAL(30,10)), A.COD_INFO_SOURCE, A.COD_GL_GROUP, 
A.DES_GL_GROUP, A.ACCOUNT_CONCEPT, A.COD_PL_ACC, A.DES_PL_ACC, A.COD_BLCE_PROD, A.DES_BLCE_PROD, A.COD_BUSINESS_LINE, A.DES_BUSINESS_LINE, A.IND_POOL, A.COD_SEGMENT, A.DES_SEGMENT, 
NULL AS EXP_TYPE, NULL AS EXP_FAMILY, A.COD_CONT, A.DATA_DATE
