...
INSERT INTO MIS_DM_BALANCE_RESULT_M PARTITION(DATA_DATE)
SELECT *
...
CAST(A.PL AS DECIMAL(30,10)) AS PL_TOT_RPT, CAST(A.PL AS DECIMAL(30,10)) AS PL_RPT, A.COD_INFO_SOURCE, A.COD_GL_GROUP, 
...
CAST(A.AVGBAL_INT AS DECIMAL(30,10)) AS AVGBAL_INT, CAST(A.PL AS DECIMAL(30,10)) AS PL, CAST(A.PL AS DECIMAL(30,10)) AS PL_TOT, CAST(A.PL AS DECIMAL(30,10)) AS PL_TOT_RPT, CAST(A.PL AS DECIMAL(30,10)) AS PL_RPT, A.COD_INFO_SOURCE, A.COD_GL_GROUP, 
A.DES_GL_GROUP, A.ACCOUNT_CONCEPT, A.COD_PL_ACC, A.DES_PL_ACC, A.COD_BLCE_PROD, A.DES_BLCE_PROD, A.COD_BUSINESS_LINE, A.DES_BUSINESS_LINE, A.IND_POOL, A.COD_SEGMENT, A.DES_SEGMENT, 
NULL AS EXP_TYPE, NULL AS EXP_FAMILY, A.COD_CONT, A.DATA_DATE
...
CAST(-1*PL_TOT_RPT AS DECIMAL(30,10)) AS PL_TOT_RPT, CAST(-1*PL_RPT AS DECIMAL(30,10)) AS PL_RPT, COD_INFO_SOURCE, COD_GL_GROUP, DES_GL_GROUP, ACCOUNT_CONCEPT, COD_PL_ACC, DES_PL_ACC, COD_BLCE_PROD, 
