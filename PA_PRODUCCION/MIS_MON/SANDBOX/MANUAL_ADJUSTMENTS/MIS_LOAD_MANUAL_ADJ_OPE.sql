...
TRUNCATE TABLE MIS_DWH_MANUAL_ADJ_OPER_ADD_CRED_CARD;
LOAD DATA INPATH '${var:ruta_fuentes_ajustes}/Ajustes_Manuales_Operacionales_TC_Adicionales.csv' INTO TABLE MIS_DWH_MANUAL_ADJ_OPER_ADD_CRED_CARD;
...
WHERE NOT EXISTS (SELECT 1
                  ...
                  WHERE idf_cto = A.contrato AND cod_acco_cent = A.centro_contable AND cod_currency = A.divisa AND cod_entity = STRRIGHT(CONCAT('0', A.entidad),2))
