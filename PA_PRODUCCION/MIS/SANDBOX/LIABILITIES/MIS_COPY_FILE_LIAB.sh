...
echo 'Inicio copia de archivos fuente de Pasivos'
...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/ACMST.CSV
hadoop dfs -cp $RUTA_ORIGEN/ACMST_$YEAR$MONTH$DAY.CSV $RUTA_DESTINO/ACMST.CSV

hadoop dfs -rm -skipTrash $RUTA_DESTINO/CNTRLRTE.CSV
hadoop dfs -cp $RUTA_ORIGEN/CNTRLRTE_$YEAR$MONTH$DAY.CSV $RUTA_DESTINO/CNTRLRTE.CSV