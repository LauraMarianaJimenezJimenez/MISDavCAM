...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/PROVEEDORES.csv
#hadoop dfs -cp $RUTA_ORIGEN/PROVEEDORES_$YEAR$MONTH$DAY.csv $RUTA_DESTINO/PROVEEDORES.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/CONTABLE.csv
#hadoop dfs -cp $RUTA_ORIGEN/CONTABLE_$YEAR$MONTH$DAY.csv $RUTA_DESTINO/CONTABLE.csv
'