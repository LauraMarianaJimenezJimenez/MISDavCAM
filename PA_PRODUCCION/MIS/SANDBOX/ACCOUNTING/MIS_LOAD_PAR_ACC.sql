...
TRUNCATE TABLE IF EXISTS MIS_PAR_CAT_BLCE_PROD;
LOAD DATA INPATH '${var:ruta_fuentes_contabilidad}/MIS_PAR_CAT_BLCE_PROD.csv' INTO TABLE MIS_PAR_CAT_BLCE_PROD;

--- Llenado de la Tabla de Catálogo de Cuenta de Gestión ---
TRUNCATE TABLE IF EXISTS MIS_PAR_CAT_PL_ACC;
LOAD DATA INPATH '${var:ruta_fuentes_contabilidad}/MIS_PAR_CAT_PL_ACC.csv' INTO TABLE MIS_PAR_CAT_PL_ACC;
