...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_REL_PROD_SPE.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_PROD_SPE.csv $RUTA_DESTINO/MIS_PAR_REL_PROD_SPE.csv
...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_REL_SECTOR.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_SECTOR.csv $RUTA_DESTINO/MIS_PAR_REL_SECTOR.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_REL_SEGMENT.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_SEGMENT.csv $RUTA_DESTINO/MIS_PAR_REL_SEGMENT.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_REL_SUBSEGMENT.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_SUBSEGMENT.csv $RUTA_DESTINO/MIS_PAR_REL_SUBSEGMENT.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/CNOFC.CSV
hadoop dfs -cp $RUTA_ORIGEN_CLIENTES/CNOFC_$YEAR$MONTH$DAY.CSV $RUTA_DESTINO/CNOFC.CSV

hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_REL_OFFI.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_OFFI.csv $RUTA_DESTINO/MIS_PAR_REL_OFFI.csv
...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_CASTIGOS.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CASTIGOS.csv $RUTA_DESTINO/MIS_PAR_CASTIGOS.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_CPS3S.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CPS3S.csv $RUTA_DESTINO/MIS_PAR_CPS3S.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_CIERRES_TAR.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CIERRES_TAR.csv $RUTA_DESTINO/MIS_PAR_CIERRES_TAR.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_REL_CAR_COVID.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_CAR_COVID.csv $RUTA_DESTINO/MIS_PAR_REL_CAR_COVID.csv
...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_REL_DATE_TAR.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_DATE_TAR.csv $RUTA_DESTINO/MIS_PAR_REL_DATE_TAR.csv
...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/MIS_PAR_REL_EXC_DLAHI.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_EXC_DLAHI.csv $RUTA_DESTINO/MIS_PAR_REL_EXC_DLAHI.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/APCLS.CSV
hadoop dfs -cp $RUTA_ORIGEN_CLIENTES/APCLS_$YEAR$MONTH$DAY.CSV $RUTA_DESTINO/APCLS.CSV
