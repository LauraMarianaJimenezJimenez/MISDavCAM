...
SELECT a.*, d.COD_BUSINESS_LINE, e.DES_BUSINESS_LINE, b.IDF_CLI, c.COD_MANAGER, c.TYP_DOC_ID, c.COD_SECTOR, c.COD_SEGMENT, c.COD_SUBSEGMENT, c.COD_TYP_CLNT
FROM (
    SELECT a.*
    FROM MIS_TMP_STG_${var:tabla}_3 a
...
GROUP BY a.DATA_DATE, a.COD_CONT, a.COD_MANAGER, a.COD_SEGMENT
HAVING SUM(IFNULL(a.EOPBAL_CAP, 0) + IFNULL(a.EOPBAL_INT, 0)) <> 0 OR SUM(a.PL) <> 0;
*/
...
SELECT 
    ...
    a.COD_ACT_TYPE, CASE WHEN b.COD_GL_GROUP IS NOT NULL THEN CAST(a.EOPBAL_CAP*-1 as DECIMAL(30,10)) ELSE a.EOPBAL_CAP END, CASE WHEN b.COD_GL_GROUP IS NOT NULL THEN CAST(a.EOPBAL_INT*-1 as DECIMAL(30,10)) ELSE a.EOPBAL_INT END, CASE WHEN b.COD_GL_GROUP IS NOT NULL THEN CAST(a.AVGBAL_CAP*-1 as DECIMAL(30,10)) ELSE a.AVGBAL_CAP END, CASE WHEN b.COD_GL_GROUP IS NOT NULL THEN CAST(a.AVGBAL_INT*-1 as DECIMAL(30,10)) ELSE a.AVGBAL_INT END, a.PL, a.COD_GL_GROUP, c.DES_GL_GROUP, c.ACCOUNT_CONCEPT,  
