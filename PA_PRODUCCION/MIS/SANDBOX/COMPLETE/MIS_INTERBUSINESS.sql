...
SELECT DISTINCT 
    TRIM(a.COD_ENTITY) AS COD_ENTITY, TRIM(a.COD_GL_GROUP) AS COD_GL_GROUP, TRIM(a.COD_ACCO_CENT) AS COD_ACCO_CENT, TRIM(a.COD_CURRENCY) AS 
    COD_CURRENCY, TRIM(a.COD_DRIVER) AS COD_DRIVER, b.COD_SEGMENT AS COD_SEGMENT_DESTINY, 
    b.COD_BLCE_PROD AS COD_BLCE_PROD_DESTINY, b.ALLOCATION_PERC , 
...
SELECT DWH.DATA_DATE, DWH.COD_ACCO_CENT, DWH.COD_BLCE_STATUS, DWH.COD_CURRENCY, DWH.COD_ENTITY, CAST(SUM(DWH.PL) AS decimal(30, 10)) AS PL, 
    TRIM(DWH.COD_GL_GROUP) AS COD_GL_GROUP, DWH.DES_GL_GROUP, DWH.ACCOUNT_CONCEPT, DWH.COD_PL_ACC, DWH.DES_PL_ACC, 
