...
--COMPUTE STATS MIS_APR_${var:tabla}_m;
...
SELECT a.*, CASE WHEN a.COD_GL IS NOT NULL THEN a.COD_GL ELSE B.COD_GL_GROUP END AS COD_GL_GROUP,
CASE WHEN IFNULL(a.COD_GL, '') = '' AND b.COD_GL_GROUP IS NOT NULL THEN d.DES_GL_GROUP
     ELSE c.DES_GL_GROUP END AS DES_GL_GROUP,
CASE WHEN IFNULL(a.COD_GL, '') = '' AND b.COD_GL_GROUP IS NOT NULL THEN d.ACCOUNT_CONCEPT
     ELSE c.ACCOUNT_CONCEPT END AS ACCOUNT_CONCEPT 
FROM (
    SELECT a.* 
...
ON b.COD_GL_GROUP=d.COD_GL_GROUP;
...
INSERT OVERWRITE MIS_REJECTIONS_DIMENSIONS_NULL
