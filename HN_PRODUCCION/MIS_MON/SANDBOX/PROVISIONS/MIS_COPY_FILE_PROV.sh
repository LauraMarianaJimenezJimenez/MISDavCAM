...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/TBL_DISTRI_CTAS_NIFF.csv
hadoop dfs -cp $RUTA_ORIGEN/TBL_DISTRI_CTAS_NIFF_$YEAR$MONTH$DAY.csv $RUTA_DESTINO/TBL_DISTRI_CTAS_NIFF.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/TBL_REPORTE_FINAL_HIST_BC.csv
hadoop dfs -cp $RUTA_ORIGEN/TBL_REPORTE_FINAL_HIST_BC_$YEAR$MONTH$DAY.csv $RUTA_DESTINO/TBL_REPORTE_FINAL_HIST_BC.csv