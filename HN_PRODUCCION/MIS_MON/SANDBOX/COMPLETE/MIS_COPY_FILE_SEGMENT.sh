...
hadoop dfs -cp $RUTA_ORIGEN_CLIENTES/MIS_SEGMENTO_BANCA_PERSONAS_$YEAR$MONTH$DAY.csv $RUTA_DESTINO/MIS_SEGMENTO_BANCA_PERSONAS.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/SEGMENTO_BANCA_EMPRESAS.csv
hadoop dfs -cp $RUTA_ORIGEN_CLIENTES/SEGMENTO_BANCA_EMPRESAS_$YEAR$MONTH$DAY.csv $RUTA_DESTINO/SEGMENTO_BANCA_EMPRESAS.csv