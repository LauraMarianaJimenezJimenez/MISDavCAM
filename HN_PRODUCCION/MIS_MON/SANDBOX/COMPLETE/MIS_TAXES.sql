...
CREATE TABLE MIS_TMP_TAXES_PAR AS 
	SELECT a.COD_ENTITY, a.COD_GL_GROUP_DESTINY AS COD_GL_GROUP, a.COD_ACCO_CENT_DESTINY AS COD_ACCO_CENT, a.TAX_PERC, b.DES_GL_GROUP, b.ACCOUNT_CONCEPT, '1' AS COD_BLCE_STATUS, d.COD_PL_ACC, e.DES_PL_ACC, 
	f.COD_BLCE_PROD, g.DES_BLCE_PROD 
	FROM MIS_PAR_TAX_ENG a 
	LEFT JOIN MIS_PAR_CAT_CAF b 
	ON a.COD_GL_GROUP_DESTINY = b.COD_GL_GROUP --AND b.COD_CURRENCY = 'HNL'
...
(COD_ACCO_CENT, COD_BLCE_STATUS, COD_CURRENCY, COD_ENTITY, EOPBAL_CAP, EOPBAL_INT, AVGBAL_CAP, AVGBAL_INT, PL, 
PL_TOT, PL_TOT_RPT, PL_RPT, COD_GL_GROUP, 
...
SELECT A.COD_ACCO_CENT, A.COD_BLCE_STATUS, 'HNL' AS COD_CURRENCY, A.COD_ENTITY, A.EOPBAL_CAP, A.EOPBAL_INT, A.AVGBAL_CAP, A.AVGBAL_INT, CAST(A.PL AS DECIMAL(30,10)), CAST(A.PL AS DECIMAL(30,10)), 
CAST(A.PL AS DECIMAL(30,10)), CAST(A.PL AS DECIMAL(30,10)), A.COD_GL_GROUP, 
