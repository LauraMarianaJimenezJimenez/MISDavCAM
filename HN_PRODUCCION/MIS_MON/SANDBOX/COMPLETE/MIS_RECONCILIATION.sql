...
DATA_DATE STRING, COD_CONT STRING, COD_GL STRING, COD_ACCO_CENT STRING, COD_CURRENCY STRING, COD_ENTITY STRING, COD_GL_GROUP STRING, DES_GL_GROUP STRING, 
...
SELECT TMP.DATA_DATE, TMP.COD_CONT, TMP.COD_GL, TMP.COD_ACCO_CENT, CASE WHEN STRLEFT(TMP.COD_GL_GROUP,1) IN ('5','6') THEN 'HNL' ELSE TMP.COD_CURRENCY END AS COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP, TMP.ACCOUNT_CONCEPT, 
    CASE WHEN TMP.COD_VALUE = 'INT' AND TMP.COD_CONT = 'PREST' THEN CAST(SUM(TMP.EOPBAL_CAP) * EXCF.EXCH_RATE AS decimal(30, 10)) ELSE CAST(SUM(TMP.EOPBAL_CAP) AS decimal(30, 10)) END AS EOPBAL_CAP, CAST(SUM(TMP.EOPBAL_INT) AS decimal(30, 10)) AS EOPBAL_INT, CAST(SUM(TMP.AVGBAL_CAP) AS decimal(30, 10)) AS AVGBAL_CAP, CAST(SUM(TMP.AVGBAL_INT) AS decimal(30, 10)) AS AVGBAL_INT, CASE WHEN TMP.COD_CURRENCY = 'HNL' THEN CAST(SUM(TMP.PL) AS decimal(30, 10)) ELSE CAST(SUM(TMP.PL) * EXCP.EXCH_RATE AS decimal(30, 10)) END AS PL 
...
GROUP BY TMP.DATA_DATE, TMP.COD_CONT, TMP.COD_GL, TMP.COD_ACCO_CENT, TMP.COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP, TMP.ACCOUNT_CONCEPT, COD_VALUE, EXCF.EXCH_RATE, EXCP.EXCH_RATE
UNION ALL
SELECT TMP.DATA_DATE, TMP.COD_CONT, TMP.COD_GL, TMP.COD_ACCO_CENT, CASE WHEN STRLEFT(TMP.COD_GL_GROUP,1) IN ('5','6') THEN 'HNL' ELSE TMP.COD_CURRENCY END AS COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP, TMP.ACCOUNT_CONCEPT,
...
WHERE TMP.DATA_DATE='${var:periodo}'
GROUP BY TMP.DATA_DATE, TMP.COD_CONT, TMP.COD_GL, TMP.COD_ACCO_CENT, TMP.COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP, TMP.DES_GL_GROUP, TMP.ACCOUNT_CONCEPT
UNION ALL
SELECT TMP.DATA_DATE, TMP.COD_CONT, TMP.COD_GL, TMP.COD_ACCO_CENT, CASE WHEN STRLEFT(TMP.COD_GL_GROUP,1) IN ('5','6') THEN 'HNL' ELSE TMP.COD_CURRENCY END AS COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP, TMP.ACCOUNT_CONCEPT, 
...
AND IF(ISNULL(TRIM(EXCP.COD_ENTITY),'') = '' ,'1',TMP.COD_ENTITY) = IF(ISNULL(TRIM(EXCP.COD_ENTITY),'') = '','1',EXCP.COD_ENTITY)
WHERE TMP.DATA_DATE='${var:periodo}'
GROUP BY TMP.DATA_DATE, TMP.COD_CONT, TMP.COD_GL, TMP.COD_ACCO_CENT, TMP.COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP, TMP.ACCOUNT_CONCEPT, EXCF.EXCH_RATE, EXCP.EXCH_RATE
UNION ALL
SELECT TMP.DATA_DATE, TMP.COD_CONT, TMP.COD_GL, TMP.COD_ACCO_CENT, CASE WHEN STRLEFT(TMP.COD_GL_GROUP,1) IN ('5','6') THEN 'HNL' ELSE TMP.COD_CURRENCY END AS COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP, TMP.ACCOUNT_CONCEPT, 
    CAST(SUM(TMP.EOPBAL_CAP) AS decimal(30, 10)) AS EOPBAL_CAP, CAST(SUM(TMP.EOPBAL_INT) AS decimal(30, 10)) AS EOPBAL_INT, CAST(SUM(TMP.AVGBAL_CAP) AS decimal(30, 10)) AS AVGBAL_CAP, CAST(SUM(TMP.AVGBAL_INT) AS decimal(30, 10)) AS AVGBAL_INT, CASE WHEN TMP.COD_CURRENCY = 'HNL' THEN CAST(SUM(TMP.PL) AS decimal(30, 10)) ELSE CAST(SUM(TMP.PL) * EXCP.EXCH_RATE AS decimal(30, 10)) END AS PL
...
GROUP BY TMP.DATA_DATE, TMP.COD_CONT, TMP.COD_GL, TMP.COD_ACCO_CENT, TMP.COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP, TMP.ACCOUNT_CONCEPT, EXCF.EXCH_RATE, EXCP.EXCH_RATE
UNION ALL
SELECT TMP.DATA_DATE, TMP.COD_CONT, NULL AS COD_GL, NULL AS COD_ACCO_CENT, TMP.COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP, TMP.ACCOUNT_CONCEPT, CAST(SUM(TMP.EOPBAL_CAP) AS decimal(30, 10)) AS EOPBAL_CAP, CAST(SUM(TMP.EOPBAL_INT) AS decimal(30, 10)) AS EOPBAL_INT, 0 AS AVGBAL_CAP, 0 AS AVGBAL_INT, CAST(SUM(TMP.PL) AS decimal(30, 10)) AS PL 
...
UNION ALL
SELECT TMP.DATA_DATE, TMP.CONTENIDO, NULL AS COD_GL, TMP.CENTRO_CONTABLE, TMP.DIVISA, TMP.ENTIDAD, TMP.AGRUPADOR_CONTABLE, c.DES_GL_GROUP, c.ACCOUNT_CONCEPT, 
    CAST(SUM(TMP.IMPORTE_ML) AS decimal(30, 10)) AS EOPBAL_CAP, 0 AS EOPBAL_INT, 0 AS AVGBAL_CAP, 0 AS AVGBAL_INT, CAST(SUM(TMP.PL_ML) AS decimal(30, 10)) AS PL 
FROM MIS_DWH_MANUAL_ADJ_OPER TMP
LEFT JOIN MIS_PAR_CAT_CAF c 
ON TMP.AGRUPADOR_CONTABLE=c.COD_GL_GROUP
WHERE TMP.DATA_DATE='${var:periodo}'
GROUP BY TMP.DATA_DATE, TMP.CONTENIDO, TMP.CENTRO_CONTABLE, TMP.DIVISA, TMP.ENTIDAD, TMP.AGRUPADOR_CONTABLE, c.DES_GL_GROUP, c.ACCOUNT_CONCEPT;
...
FROM (
    ...
    LEFT JOIN (SELECT DISTINCT COD_GL_GROUP FROM MIS_PAR_REL_CAF_OPER) PAR
    ON TMP.COD_GL_GROUP = PAR.COD_GL_GROUP
    WHERE TMP.DATA_DATE='${var:periodo}' AND (PAR.COD_GL_GROUP IS NOT NULL OR TMP.COD_GL IS NOT NULL)
...
FULL JOIN (
    ...
    LEFT JOIN (SELECT DISTINCT COD_GL_GROUP FROM MIS_PAR_REL_CAF_OPER) PAR
    ON ACC.COD_GL_GROUP = PAR.COD_GL_GROUP
    LEFT JOIN (SELECT DISTINCT COD_GL, COD_GL_GROUP FROM MIS_TMP_DWH_OPERACIONAL) TMP
    ON ACC.COD_GL_GROUP = TMP.COD_GL_GROUP
    WHERE ACC.DATA_DATE='${var:periodo}' AND (PAR.COD_GL_GROUP IS NOT NULL OR TMP.cod_gl IS NOT NULL)
...
FROM (
    ...
    LEFT JOIN (SELECT DISTINCT COD_GL_GROUP FROM MIS_PAR_REL_CAF_OPER) PAR
    ON TMP.COD_GL_GROUP = PAR.COD_GL_GROUP
    WHERE TMP.DATA_DATE='${var:periodo}' AND (PAR.COD_GL_GROUP IS NULL AND TMP.cod_gl IS NULL)
    GROUP BY TMP.DATA_DATE, TMP.COD_CURRENCY, TMP.COD_ENTITY, TMP.COD_GL_GROUP, TMP.DES_GL_GROUP,
        TMP.ACCOUNT_CONCEPT) OPER 
FULL JOIN (
    ...
    LEFT JOIN (SELECT DISTINCT COD_GL, COD_GL_GROUP FROM MIS_TMP_DWH_OPERACIONAL) TMP
    ON ACC.COD_GL_GROUP = TMP.COD_GL_GROUP
    WHERE ACC.DATA_DATE='${var:periodo}' AND (PAR.COD_GL_GROUP IS NULL AND TMP.cod_gl IS NULL)
...
--COMPUTE STATS MIS_DWH_RECONCILIATION_AUX_M;
...
--COMPUTE STATS MIS_TMP_STG_RECONC_M_3;
...
SELECT DWH.COD_ACCO_CENT, DWH.COD_OFFI, DWH.COD_NAR, '0' AS COD_BLCE_STATUS, DWH.COD_CURRENCY, DWH.COD_ENTITY,
    ...
    DWH.EXP_TYPE, DWH.EXP_FAMILY, NULL, DWH.DATA_DATE, DWH.COD_CONT 
