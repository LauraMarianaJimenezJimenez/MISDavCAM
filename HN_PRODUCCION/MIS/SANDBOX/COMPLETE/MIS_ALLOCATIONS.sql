...
--COMPUTE STATS MIS_TMP_PAR_AC_DRI;
...
--COMPUTE STATS MIS_TMP_PAR_SEG_DRI;
...
SELECT DWH.DATA_DATE, DWH.COD_ACCO_CENT, DWH.COD_EXPENSE, DWH.COD_BLCE_STATUS, DWH.COD_CURRENCY, DWH.COD_ENTITY, CAST(SUM(DWH.PL) AS decimal(30, 10)) AS PL, 
    ...
    DWH.COD_SEGMENT, DWH.DES_SEGMENT, DWH.COD_BLCE_PROD, DWH.DES_BLCE_PROD, DWH.COD_BUSINESS_LINE, DWH.DES_BUSINESS_LINE, DWH.EXP_TYPE, DWH.EXP_FAMILY
...
ON a.COD_BLCE_PROD = b.cod_level_06
