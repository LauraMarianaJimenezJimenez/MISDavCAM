...
echo 'Inicio copia de archivos de Clientes'
...
export RUTA_ORIGEN=${ruta_origen_clientes}
export RUTA_DESTINO=${ruta_fuentes_clientes}
...
hdfs dfs -rm -skipTrash $RUTA_DESTINO/MIS_CLIENTES.CSV
hdfs dfs -cp  $RUTA_ORIGEN/cl_produc_cli_$YEAR$MONTH$DAY.csv $RUTA_DESTINO/MIS_CLIENTES.CSV