...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_BP_ACC_"$YEAR$MONTH$DAY.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_BP_ACC.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_BP_ACC_"$YEAR$MONTH$DAY.csv
...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_PL_"$YEAR$MONTH$DAY.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CAT_PL.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_PL_"$YEAR$MONTH$DAY.csv

hadoop dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_BP_"$YEAR$MONTH$DAY.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CAT_BP.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_BP_"$YEAR$MONTH$DAY.csv
...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_ECO_GRO_"$YEAR$MONTH$DAY.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CAT_ECO_GRO.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_ECO_GRO_"$YEAR$MONTH$DAY.csv
...
hadoop dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_BP_OPER_"$YEAR$MONTH$DAY.csv
hadoop dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_BP_OPER.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_BP_OPER_"$YEAR$MONTH$DAY.csv
...
hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_ENTITY_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_ENTITY.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_ENTITY_"$YEAR$MONTH$DAY.csv

hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_HIERARCHY_PL_ACC_LC_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_HIERARCHY_PL_ACC_LC.csv $RUTA_DESTINO/$FECHA$"_MIS_HIERARCHY_PL_ACC_LC_"$YEAR$MONTH$DAY.csv

hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_HIERARCHY_BLCE_PROD_LC_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_HIERARCHY_BLCE_PROD_LC.csv $RUTA_DESTINO/$FECHA$"_MIS_HIERARCHY_BLCE_PROD_LC_"$YEAR$MONTH$DAY.csv

hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_OFFI_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CAT_OFFI.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_OFFI_"$YEAR$MONTH$DAY.csv

hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_ACCO_CENT_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CAT_ACCO_CENT.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_ACCO_CENT_"$YEAR$MONTH$DAY.csv

hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_EXPENSE_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CAT_EXPENSE.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_EXPENSE_"$YEAR$MONTH$DAY.csv

hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_INST_CLI_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_CAT_INST_CLI.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_CAT_INST_CLI_"$YEAR$MONTH$DAY.csv

hdfs dfs -rm -skipTrash $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_PROG_CARD_"$YEAR$MONTH$DAY.csv
hdfs dfs -cp $RUTA_ORIGEN_PAR/MIS_PAR_REL_PROG_CARD.csv $RUTA_DESTINO/$FECHA$"_MIS_PAR_REL_PROG_CARD_"$YEAR$MONTH$DAY.csv