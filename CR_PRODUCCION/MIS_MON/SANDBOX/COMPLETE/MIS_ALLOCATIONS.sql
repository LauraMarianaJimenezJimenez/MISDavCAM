...
TRUNCATE TABLE IF EXISTS MIS_TMP_PAR_AC_DRI_M;
DROP TABLE IF EXISTS MIS_TMP_PAR_AC_DRI_M;
CREATE TABLE MIS_TMP_PAR_AC_DRI_M AS 
...
TRUNCATE TABLE IF EXISTS MIS_TMP_PAR_SEG_DRI_M;
DROP TABLE IF EXISTS MIS_TMP_PAR_SEG_DRI_M;
CREATE TABLE MIS_TMP_PAR_SEG_DRI_M AS 
...
TRUNCATE TABLE IF EXISTS MIS_TMP_PAR_ALLOC_AC_M;
DROP TABLE IF EXISTS MIS_TMP_PAR_ALLOC_AC_M;
CREATE TABLE MIS_TMP_PAR_ALLOC_AC_M AS
SELECT DISTINCT 
...
LEFT JOIN MIS_TMP_PAR_AC_DRI_M b
ON a.COD_DRIVER = b.COD_DRIVER;

------------ Creación de la tabla Repartos por Segmento-Producto con Descripciones ------------
TRUNCATE TABLE IF EXISTS MIS_TMP_PAR_ALLOC_SEG_M;
DROP TABLE IF EXISTS MIS_TMP_PAR_ALLOC_SEG_M;
CREATE TABLE MIS_TMP_PAR_ALLOC_SEG_M AS
SELECT DISTINCT 
...
LEFT JOIN MIS_TMP_PAR_SEG_DRI_M b 
ON a.COD_DRIVER = b.COD_DRIVER 
...
TRUNCATE TABLE IF EXISTS MIS_TMP_ALLOC_STG_INI_M;
DROP TABLE IF EXISTS MIS_TMP_ALLOC_STG_INI_M;
CREATE TABLE MIS_TMP_ALLOC_STG_INI_M AS 
...
TRUNCATE TABLE IF EXISTS MIS_TMP_ALLOC_1_M; 
DROP TABLE IF EXISTS MIS_TMP_ALLOC_1_M; 
CREATE TABLE MIS_TMP_ALLOC_1_M AS 
...
FROM MIS_TMP_ALLOC_STG_INI_M DWH
LEFT JOIN MIS_TMP_PAR_ALLOC_AC_M AL1 
...
LEFT JOIN MIS_TMP_PAR_ALLOC_AC_M AL2 
...
LEFT JOIN MIS_TMP_PAR_ALLOC_AC_M AL3 
...
LEFT JOIN MIS_TMP_PAR_ALLOC_AC_M AL4 
...
LEFT JOIN MIS_TMP_PAR_ALLOC_AC_M AL5 
...
LEFT JOIN MIS_TMP_PAR_ALLOC_AC_M AL6 
...
LEFT JOIN MIS_TMP_PAR_ALLOC_AC_M AL7 
...
TRUNCATE TABLE IF EXISTS MIS_TMP_ALLOC_2_M; 
DROP TABLE IF EXISTS MIS_TMP_ALLOC_2_M; 
CREATE TABLE MIS_TMP_ALLOC_2_M AS 
SELECT DWH.DATA_DATE, DWH.COD_ACCO_CENT, DWH.COD_EXPENSE, DWH.COD_BLCE_STATUS, DWH.COD_CURRENCY, DWH.COD_ENTITY, 
    ...
    COALESCE(AL1.COD_DRIVER, AL2.COD_DRIVER, AL3.COD_DRIVER, AL4.COD_DRIVER, 
                AL5.COD_DRIVER, AL6.COD_DRIVER, AL7.COD_DRIVER) AS COD_DRIVER
FROM MIS_TMP_ALLOC_1_M DWH
LEFT JOIN MIS_TMP_PAR_ALLOC_SEG_M AL1 
ON DWH.COD_ENTITY=AL1.COD_ENTITY AND DWH.COD_CURRENCY=AL1.COD_CURRENCY 
   AND DWH.COD_EXPENSE=AL1.COD_EXPENSE AND DWH.COD_ACCO_CENT=AL1.COD_ACCO_CENT AND DWH.COD_GL_GROUP=AL1.COD_GL_GROUP 
LEFT JOIN MIS_TMP_PAR_ALLOC_SEG_M AL2 
ON COALESCE(AL1.COD_DRIVER) IS NULL 
   AND DWH.COD_ENTITY=AL2.COD_ENTITY AND DWH.COD_CURRENCY=AL2.COD_CURRENCY 
   AND DWH.COD_EXPENSE=AL2.COD_EXPENSE AND DWH.COD_ACCO_CENT=AL2.COD_ACCO_CENT AND TRIM(AL2.COD_GL_GROUP) = '' 
LEFT JOIN MIS_TMP_PAR_ALLOC_SEG_M AL3 
ON COALESCE(AL1.COD_DRIVER, AL2.COD_DRIVER) IS NULL 
   AND DWH.COD_ENTITY=AL3.COD_ENTITY AND DWH.COD_CURRENCY=AL3.COD_CURRENCY 
   AND DWH.COD_EXPENSE=AL3.COD_EXPENSE AND TRIM(AL3.COD_ACCO_CENT) = '' AND DWH.COD_GL_GROUP=AL3.COD_GL_GROUP    
LEFT JOIN MIS_TMP_PAR_ALLOC_SEG_M AL4 
ON COALESCE(AL1.COD_DRIVER, AL2.COD_DRIVER, AL3.COD_DRIVER) IS NULL 
   AND DWH.COD_ENTITY=AL4.COD_ENTITY AND DWH.COD_CURRENCY=AL4.COD_CURRENCY 
   AND TRIM(AL4.COD_EXPENSE) = '' AND DWH.COD_ACCO_CENT=AL4.COD_ACCO_CENT AND DWH.COD_GL_GROUP=AL4.COD_GL_GROUP 
LEFT JOIN MIS_TMP_PAR_ALLOC_SEG_M AL5 
ON COALESCE(AL1.COD_DRIVER, AL2.COD_DRIVER, AL3.COD_DRIVER, AL4.COD_DRIVER) IS NULL
   AND DWH.COD_ENTITY=AL5.COD_ENTITY AND DWH.COD_CURRENCY=AL5.COD_CURRENCY 
   AND DWH.COD_EXPENSE=AL5.COD_EXPENSE AND TRIM(AL5.COD_ACCO_CENT) = '' AND TRIM(AL5.COD_GL_GROUP) = '' 
LEFT JOIN MIS_TMP_PAR_ALLOC_SEG_M AL6 
ON COALESCE(AL1.COD_DRIVER, AL2.COD_DRIVER, AL3.COD_DRIVER, AL4.COD_DRIVER, AL5.COD_DRIVER) IS NULL 
   AND DWH.COD_ENTITY=AL6.COD_ENTITY AND DWH.COD_CURRENCY=AL6.COD_CURRENCY 
   AND TRIM(AL6.COD_EXPENSE) = '' AND DWH.COD_ACCO_CENT=AL6.COD_ACCO_CENT AND TRIM(AL6.COD_GL_GROUP) = '' 
LEFT JOIN MIS_TMP_PAR_ALLOC_SEG_M AL7 
ON COALESCE(AL1.COD_DRIVER, AL2.COD_DRIVER, AL3.COD_DRIVER, AL4.COD_DRIVER, AL5.COD_DRIVER, AL6.COD_DRIVER) IS NULL 
   AND DWH.COD_ENTITY=AL7.COD_ENTITY AND DWH.COD_CURRENCY=AL7.COD_CURRENCY 
   AND TRIM(AL7.COD_EXPENSE) = '' AND TRIM(AL7.COD_ACCO_CENT) = '' AND DWH.COD_GL_GROUP=AL7.COD_GL_GROUP 
;
...
SELECT DWH.COD_ACCO_CENT, DWH.COD_BLCE_STATUS, DWH.COD_CURRENCY, DWH.COD_ENTITY, 
    ...
    DWH.COD_GL_GROUP, DWH.DES_GL_GROUP, DWH.ACCOUNT_CONCEPT, DWH.COD_PL_ACC, DWH.DES_PL_ACC, 
    DWH.COD_BLCE_PROD, DWH.DES_BLCE_PROD, ISNULL(HIE.COD_BUSINESS_LINE,HIE2.COD_BUSINESS_LINE) AS COD_BUSINESS_LINE, CAT.DES_BUSINESS_LINE, 
    DWH.COD_SEGMENT, DWH.DES_SEGMENT, 
    CASE 
        WHEN AL1.EXP_TYPE IS NOT NULL THEN AL1.EXP_TYPE
        WHEN AL2.EXP_TYPE IS NOT NULL THEN AL2.EXP_TYPE
...
GROUP BY DWH.COD_ACCO_CENT, DWH.COD_BLCE_STATUS, DWH.COD_CURRENCY, DWH.COD_ENTITY,  
    ...
    DWH.COD_SEGMENT, DWH.DES_SEGMENT, DWH.EXP_TYPE, DWH.EXP_FAMILY, DWH.COD_EXPENSE, DWH.COD_DRIVER,
    DWH.DATA_DATE, AL1.EXP_TYPE, AL2.EXP_TYPE, AL3.EXP_TYPE, AL4.EXP_TYPE, AL5.EXP_TYPE, AL6.EXP_TYPE, 
    AL7.EXP_TYPE, AL1.EXP_FAMILY, AL2.EXP_FAMILY, AL3.EXP_FAMILY, AL4.EXP_FAMILY, AL5.EXP_FAMILY, AL6.EXP_FAMILY, AL7.EXP_FAMILY;
...
GROUP BY DWH.COD_ACCO_CENT, DWH.COD_BLCE_STATUS, DWH.COD_CURRENCY, DWH.COD_ENTITY,  
    DWH.COD_GL_GROUP, DWH.DES_GL_GROUP, DWH.ACCOUNT_CONCEPT, DWH.COD_PL_ACC, DWH.DES_PL_ACC, 
    DWH.COD_BLCE_PROD_ORIGIN, DWH.DES_BLCE_PROD_ORIGIN, DWH.COD_BUSINESS_LINE, DWH.DES_BUSINESS_LINE, 
    DWH.COD_SEGMENT_ORIGIN, DWH.DES_SEGMENT_ORIGIN, DWH.EXP_TYPE, DWH.EXP_FAMILY, DWH.COD_EXPENSE, DWH.COD_DRIVER, 
    DWH.DATA_DATE, AL1.EXP_TYPE, AL2.EXP_TYPE, AL3.EXP_TYPE, AL4.EXP_TYPE, AL5.EXP_TYPE, AL6.EXP_TYPE, AL7.EXP_TYPE, 
    AL1.EXP_FAMILY, AL2.EXP_FAMILY, AL3.EXP_FAMILY, AL4.EXP_FAMILY, AL5.EXP_FAMILY, AL6.EXP_FAMILY, AL7.EXP_FAMILY;
...
TRUNCATE TABLE IF EXISTS MIS_TMP_ALLOC_DES_VALIDATION_M;
DROP TABLE IF EXISTS MIS_TMP_ALLOC_DES_VALIDATION_M;
CREATE TABLE MIS_TMP_ALLOC_DES_VALIDATION_M (
COD_VALIDATION STRING, DES_VALIDATION STRING); 

----Tabla temporal para almacenar resultados
TRUNCATE TABLE IF EXISTS MIS_TMP_ALLOC_VALIDATION_M;
DROP TABLE IF EXISTS MIS_TMP_ALLOC_VALIDATION_M;
CREATE TABLE MIS_TMP_ALLOC_VALIDATION_M (
COD_DRIVER STRING, DIMENSION STRING, COD_VALIDATION STRING, VALIDATION_FIELD STRING);

----Descripción de validaciones a realizar
INSERT INTO MIS_TMP_ALLOC_DES_VALIDATION_M VALUES ('001', 'El porcentaje total repartido no es igual a 1 (100%)');
INSERT INTO MIS_TMP_ALLOC_DES_VALIDATION_M VALUES ('002', 'Hay porcentajes de repartición fuera del rango definido (0 a 1)');
INSERT INTO MIS_TMP_ALLOC_DES_VALIDATION_M VALUES ('003', 'Hay Centros de Costo sin parametrizar en la tabla MIS_PAR_REL_EXP_TYP');
INSERT INTO MIS_TMP_ALLOC_DES_VALIDATION_M VALUES ('004', 'Hay Segmentos sin parametrizar en las tabla MIS_PAR_REL_SEGMENT');
INSERT INTO MIS_TMP_ALLOC_DES_VALIDATION_M VALUES ('005', 'Hay Productos de Balance sin parametrizar en las tablas MIS_PAR_REL_BP_ACC O MIS_PAR_REL_BP_OPER');
INSERT INTO MIS_TMP_ALLOC_DES_VALIDATION_M VALUES ('006', 'El driver no fue parametrizado en la tabla de drivers MIS_PAR_ALLOC_AC_DRI');
INSERT INTO MIS_TMP_ALLOC_DES_VALIDATION_M VALUES ('007', 'El driver no fue parametrizado en la tabla de drivers MIS_PAR_ALLOC_SEG_DRI');

----Validación de porcentaje total a repartir por Centro de Costo
INSERT INTO MIS_TMP_ALLOC_VALIDATION_M
...
/*INSERT INTO MIS_TMP_ALLOC_VALIDATION_M --TODO: EXCLUSION DE CODIGO O DEFINICION DE PAR_REL_SEGMENT
...
FROM MIS_TMP_ALLOC_VALIDATION_M a
LEFT JOIN MIS_TMP_ALLOC_DES_VALIDATION_M b
